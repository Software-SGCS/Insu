...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Count2 = "2" Then
                CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation2.aspx' and Form_level2='1'", CON)

            Else
                If Count2 = "3" Then
                    CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation2.aspx' and Form_level3='1'", CON)

                Else
                    If Count2 = "4" Then
                        CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation2.aspx' and Form_level4='1'", CON)
                    Else
                        If Count2 = "5" Then

                            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation2.aspx' and Form_level5='1'", CON)
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select Id,Emp_Nam,Emp_RelType,Convert(Varchar(10),Emp_Dob,103) as Emp_Dob,Emp_DeathAmt as Emp_Deathamt, Convert(Varchar(10),Emp_PayDt,103) as Emp_Paydt,Emp_chqno from RelationMaster where emp_No='" & Trim(TempEmpno) & "' and Emp_Com='" & Trim(TempCom) & "'", CON)
