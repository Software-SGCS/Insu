...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='AccidentForm1.aspx' and Form_level='" & Global.PwLevel & "'", CON)
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select Veh_No,Veh_Com, Veh_Typ,Convert(varchar(10),Veh_EfDt,103) as Veh_EfDt, convert(varchar(10),Veh_Exdt,103) as Veh_Exdt, Veh_tpay ,Veh_val,ALLOW2,Veh_bpay,Veh_rcc,Veh_tr from VehMast where ALLOW2='Select' ", objConn)
