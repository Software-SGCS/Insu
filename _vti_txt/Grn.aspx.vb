...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='Grn.aspx' and Form_level='" & Global.PwLevel & "'", CON)
    ...
    Private Sub LstId_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LstId.SelectedIndexChanged
        ...
        If Count <> 0 Then
            ...
            For Each dr1 In DS.Tables("InhPur").Rows
                ...
                Invpaydt = IIf(IsDBNull(dr1("Inv_Paydt")), " ", dr1("Inv_Paydt"))
    ...
    Private Sub BtnApp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnApp.Click
        ...
        If BtnAdd.Enabled = False Then
            ...
            If Count <> 0 Then
                ...
                CMD.Connection = CON
                Dim SS As String
                SS = "UPDATE InhPur SET Inv_crdlmt=" & CrdLmt & ",Inv_Grnno='" & TxtGrnNo.Text & "',Inv_BilDt='" & DateValue(Mid(Trim(TxtBilDt.Text), 4, 2) + "/" + Mid(Trim(TxtBilDt.Text), 1, 2) + "/" + Mid(Trim(TxtBilDt.Text), 7, 4)) & "',Inv_pDt='" & DateValue(Mid(Trim(TxtPaydt.Text), 4, 2) + "/" + Mid(Trim(TxtPaydt.Text), 1, 2) + "/" + Mid(Trim(TxtPaydt.Text), 7, 4)) & "',Inv_RecDt='" & DateValue(Mid(Trim(TxtRecDt.Text), 4, 2) + "/" + Mid(Trim(TxtRecDt.Text), 1, 2) + "/" + Mid(Trim(TxtRecDt.Text), 7, 4)) & "' WHERE Inv_NO='" & IDNO & "'"
    ...
    Private Sub TxtRecDt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtRecDt.TextChanged
        ...
        Else
            ...
            TxtPaydt.Text = DateAdd(DateInterval.Day, Val(TxtCrdLmt.Text), CDate(Mid(TxtRecDt.Text, 1, 2) + "/" + Mid(TxtRecDt.Text, 4, 2) + "/" + Mid(TxtRecDt.Text, 7, 4)))
