...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<DIV id="Layer1" style="Z-INDEX: 121; LEFT: 144px; OVERFLOW: scroll; WIDTH: 954px; POSITION: absolute; TOP: 136px; HEIGHT: 688px"><CR:CRYSTALREPORTVIEWER id="CrystalReportViewer2" runat="server" Visible="False" Width="350px" Height="50px"
			...
			<asp:button id="Button7" style="Z-INDEX: 119; LEFT: 152px; POSITION: absolute; TOP: 240px" runat="server"
				...
				Width="72px" Height="24px">To Date</asp:label><asp:calendar id="Calendar1" style="Z-INDEX: 115; LEFT: 320px; POSITION: absolute; TOP: 104px"
			...
			</asp:calendar><asp:calendar id="Calendar2" style="Z-INDEX: 116; LEFT: 520px; POSITION: absolute; TOP: 104px"
