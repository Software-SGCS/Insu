<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NewEntry2New1.aspx.vb" Inherits="Insu.NewEntry2New1" %>
	...
	<body bgColor="#f0f8ff" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:dropdownlist id="LstCat" style="Z-INDEX: 101; LEFT: 256px; POSITION: absolute; TOP: 72px" runat="server"
				Height="24px" Width="416px" AutoPostBack="True"></asp:dropdownlist><asp:panel id="Panel11" style="Z-INDEX: 110; LEFT: 8px; POSITION: absolute; TOP: 562px" runat="server"
			...
			<DIV id="Layer1" style="Z-INDEX: 103; LEFT: 120px; OVERFLOW: scroll; WIDTH: 784px; POSITION: relative; TOP: 104px; HEIGHT: 376px"><asp:datagrid id="DataGrid1" runat="server" Height="60px" Width="776px" BackColor="White" Font-Size="Small"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="New EmpNo">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
			...
			<asp:button id="ButSub" style="Z-INDEX: 104; LEFT: 128px; POSITION: absolute; TOP: 512px" runat="server"
				...
				Height="24px" Width="952px">&nbsp;<STRONG><FONT face="Tahoma" size="5">Employees-DDF</FONT></STRONG></asp:panel>
