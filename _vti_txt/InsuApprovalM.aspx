...
<HTML>
	...
	<BODY topMargin="45" MS_POSITIONING="GridLayout">
		<FORM id="Form1" runat="server">
			<div id="Layer1" style="Z-INDEX: 115; LEFT: 120px; OVERFLOW: scroll; WIDTH: 750px; POSITION: absolute; TOP: 96px; HEIGHT: 284px"><asp:datagrid id="dtgCustomers" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px; Design_Time_Lock: True"
			...
			<asp:radiobutton id="Radiobutton2" style="Z-INDEX: 118; LEFT: 608px; POSITION: absolute; TOP: 72px"
			...
			<asp:radiobutton id="Radiobutton1" style="Z-INDEX: 117; LEFT: 496px; POSITION: absolute; TOP: 72px"
			...
			<asp:label id="Label8" style="Z-INDEX: 116; LEFT: 312px; POSITION: absolute; TOP: 72px" runat="server"
				Height="24px" Width="184px" BackColor="RoyalBlue" ForeColor="White">Preview Insurence Certificate</asp:label>
			<asp:panel id="Panel7" style="Z-INDEX: 109; LEFT: 0px; POSITION: absolute; TOP: 160px" runat="server"
...
Page&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Insurence 
Certificate Approval</asp:panel><asp:label id="Label6" style="Z-INDEX: 103; LEFT: 288px; POSITION: absolute; TOP: 40px" runat="server"
				Width="80px" Height="24px" Visible="False">Pass Word</asp:label><asp:textbox id="TxtUser1" style="Z-INDEX: 101; LEFT: 272px; POSITION: absolute; TOP: 40px" runat="server"
				...
				Width="104px" Height="16px" Visible="False">User Code</asp:label><asp:textbox id="TxtNam" style="Z-INDEX: 104; LEFT: 216px; POSITION: absolute; TOP: 40px" runat="server"
				Width="418px" Height="24px"></asp:textbox><asp:label id="Label7" style="Z-INDEX: 105; LEFT: 128px; POSITION: absolute; TOP: 40px" runat="server"
				Width="96px" Height="24px">Name</asp:label><asp:panel id="Panel8" style="Z-INDEX: 110; LEFT: 0px; POSITION: absolute; TOP: 432px" runat="server"
				Width="888px" Height="40px" BackColor="Desktop"></asp:panel><asp:textbox id="Txtss" style="Z-INDEX: 111; LEFT: 632px; POSITION: absolute; TOP: 40px" runat="server"
				Width="56px" Height="26px" Visible="False"></asp:textbox><asp:textbox id="TxtMail" style="Z-INDEX: 112; LEFT: 624px; POSITION: absolute; TOP: 40px" runat="server"
			...
			<asp:Button id="BttApp" style="Z-INDEX: 120; LEFT: 144px; POSITION: absolute; TOP: 392px" runat="server"
				Width="160px" Height="32px" Text="Approval All"></asp:Button>
			<asp:Label id="L1" style="Z-INDEX: 121; LEFT: 496px; POSITION: absolute; TOP: 416px" runat="server"
				Width="104px" Height="16px">Label</asp:Label></FORM>
	</BODY>
</HTML>
