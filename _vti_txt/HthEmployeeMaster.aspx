<%@ Page Language="vb" AutoEventWireup="false" Codebehind="HthEmployeeMaster.aspx.vb" Inherits="Insu.HthEmployeeMaster" %>
	...
	<body bgColor="#ffffff" leftMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:textbox id="Txtchd" style="Z-INDEX: 116; LEFT: 416px; POSITION: absolute; TOP: 216px" tabIndex="8"
				...
				Width="932px" Height="64px" BackColor="Desktop" Font-Bold="True" HorizontalAlign="Left" Enabled="False" ForeColor="White" BorderColor="Transparent" BackImageUrl="Menu/banner.jpg"><FONT style="BACKGROUND-COLOR: #000066">
					...
					<DIV id="Layer1" style="Z-INDEX: 102; LEFT: 120px; OVERFLOW: scroll; WIDTH: 768px; POSITION: absolute; TOP: 328px; HEIGHT: 214px">
						<asp:datagrid id="MyDataGrid" runat="server" Width="712px" Height="12px" BackColor="White" BorderColor="MidnightBlue"
			...
			<asp:panel id="Panel2" style="Z-INDEX: 102; LEFT: 0px; POSITION: absolute; TOP: 608px" runat="server"
				...
				runat="server" Width="344px"></asp:textbox><asp:textbox id="TxtRelId" style="Z-INDEX: 115; LEFT: 432px; POSITION: absolute; TOP: 288px"
				tabIndex="7" runat="server" Width="96px"></asp:textbox><asp:textbox id="LstCom" style="Z-INDEX: 118; LEFT: 712px; POSITION: absolute; TOP: 112px" runat="server"
