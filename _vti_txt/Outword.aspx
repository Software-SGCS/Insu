...
<HTML>
	...
	<body leftMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label12" style="Z-INDEX: 138; LEFT: 528px; POSITION: absolute; TOP: 400px" runat="server"
				Width="56px" Height="24px">Percentage</asp:label><asp:dropdownlist id="LstFlag2" style="Z-INDEX: 136; LEFT: 456px; POSITION: absolute; TOP: 400px"
				tabIndex="2" runat="server" Width="56px" Height="16px" AutoPostBack="True"></asp:dropdownlist><asp:label id="Label11" style="Z-INDEX: 135; LEFT: 344px; POSITION: absolute; TOP: 400px" runat="server"
				Width="104px" Height="24px">Price Adjestment</asp:label><asp:label id="Label10" style="Z-INDEX: 134; LEFT: 232px; POSITION: absolute; TOP: 400px" runat="server"
				Width="40px" Height="24px">Vat</asp:label><asp:dropdownlist id="LstVat" style="Z-INDEX: 133; LEFT: 272px; POSITION: absolute; TOP: 400px" tabIndex="2"
				runat="server" Width="56px" Height="16px" AutoPostBack="True"></asp:dropdownlist><asp:dropdownlist id="LstCode" style="Z-INDEX: 131; LEFT: 200px; POSITION: absolute; TOP: 472px" tabIndex="2"
				runat="server" Width="176px" Height="16px" Visible="False"></asp:dropdownlist><asp:label id="Label9" style="Z-INDEX: 130; LEFT: 120px; POSITION: absolute; TOP: 472px" runat="server"
				Width="64px" Height="24px" Visible="False">Create By</asp:label><asp:button id="Button1" style="Z-INDEX: 129; LEFT: 672px; POSITION: absolute; TOP: 448px" tabIndex="9"
				runat="server" Width="64px" Height="22px" Text="Invoice" Font-Bold="True"></asp:button><asp:button id="BtnSubmit" style="Z-INDEX: 126; LEFT: 696px; POSITION: absolute; TOP: 208px"
				...
				BackColor="Desktop" Width="104px" Height="361px" BackImageUrl="Menu/Audit.gif"></asp:panel><asp:panel id="Panel1" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px" runat="server"
				BackColor="Desktop" BorderColor="Transparent" Width="879px" Height="32px" Font-Bold="True" ForeColor="White" Enabled="False" HorizontalAlign="Left">INVOICE</asp:panel>
			<asp:panel id="Panel2" style="Z-INDEX: 102; LEFT: 0px; POSITION: absolute; TOP: 32px" runat="server"
				BackColor="Desktop" Width="104px" Height="120px" BackImageUrl="Menu/AssetI.gif"></asp:panel><asp:panel id="Panel3" style="Z-INDEX: 103; LEFT: 0px; POSITION: absolute; TOP: 152px" runat="server"
				BackColor="Desktop" Width="880px" Height="34px" Font-Bold="True" ForeColor="White">Payment Detail</asp:panel>
			<asp:button id="BtnEdit" style="Z-INDEX: 104; LEFT: 216px; POSITION: absolute; TOP: 448px" tabIndex="8"
				...
				Width="72px"></asp:textbox><asp:button id="BtnCle" style="Z-INDEX: 105; LEFT: 216px; POSITION: absolute; TOP: 448px" tabIndex="9"
				runat="server" Width="64px" Height="22px" Text="Clear" Font-Bold="True"></asp:button><asp:textbox id="TxtInvNo" style="Z-INDEX: 127; LEFT: 240px; POSITION: absolute; TOP: 40px" runat="server"
				Width="124px" Height="18px"></asp:textbox><asp:button id="BtnDel" style="Z-INDEX: 106; LEFT: 312px; POSITION: absolute; TOP: 448px" tabIndex="11"
				runat="server" Width="64px" Height="22px" Text="Delete" Font-Bold="True"></asp:button><asp:button id="BtnSave" style="Z-INDEX: 128; LEFT: 560px; POSITION: absolute; TOP: 448px; Design_Time_Lock: True"
				tabIndex="11" runat="server" Width="64px" Height="22px" Text="Save" Font-Bold="True" Design_Time_Lock="True"></asp:button><asp:textbox id="TxtPer" style="Z-INDEX: 137; LEFT: 608px; POSITION: absolute; TOP: 400px" runat="server"
				Width="52px"></asp:textbox><asp:button id="BtnAdd" style="Z-INDEX: 139; LEFT: 112px; POSITION: absolute; TOP: 448px" runat="server"
				Width="64px" Height="22px" Text="Add" Font-Bold="True"></asp:button><asp:imagebutton id="ImgBt" style="Z-INDEX: 140; LEFT: 328px; POSITION: absolute; TOP: 104px" runat="server"
				...
				tabIndex="1000" runat="server" BackColor="White" Font-Size="9pt" BorderColor="White" Width="180px" Font-Names="Verdana" BorderWidth="1px" Height="184px" ForeColor="Black" Visible="False" NextPrevFormat="FullMonth"
				CellPadding="1">
			...
			<asp:Label id="Label13" style="Z-INDEX: 142; LEFT: 568px; POSITION: absolute; TOP: 40px" runat="server"
				Width="112px" Height="24px">Last Invoice No</asp:Label>
			<asp:TextBox id="TxtLInvNo" style="Z-INDEX: 143; LEFT: 688px; POSITION: absolute; TOP: 40px"
				runat="server" Width="112px" ReadOnly="True"></asp:TextBox>
			<asp:panel id="Panel6" style="Z-INDEX: 144; LEFT: 0px; POSITION: absolute; TOP: 504px" runat="server"
				Width="874px" BackColor="Desktop" Height="43px" Font-Bold="True"></asp:panel>
			<asp:label id="Label14" style="Z-INDEX: 145; LEFT: 120px; POSITION: absolute; TOP: 400px" runat="server"
				Width="40px" Height="24px">T.T</asp:label>
			<asp:dropdownlist id="LstTT" style="Z-INDEX: 146; LEFT: 160px; POSITION: absolute; TOP: 400px" tabIndex="2"
				runat="server" Width="56px" Height="16px" AutoPostBack="True"></asp:dropdownlist>
			<asp:Label id="Label15" style="Z-INDEX: 147; LEFT: 120px; POSITION: absolute; TOP: 424px" runat="server"
				Width="128px" Height="24px">Special Vat Invoice</asp:Label>
			<asp:dropdownlist id="Lstvat1" style="Z-INDEX: 148; LEFT: 272px; POSITION: absolute; TOP: 424px" tabIndex="2"
