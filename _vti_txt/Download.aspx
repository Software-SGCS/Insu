	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:textbox id="txtMyFile" style="Z-INDEX: 102; LEFT: 632px; POSITION: absolute; TOP: 240px"
				...
				runat="server" Width="168px" Height="32px" AutoPostBack="True"></asp:dropdownlist><cr:crystalreportviewer id="CrystalReportViewer1" style="Z-INDEX: 106; LEFT: 24px; POSITION: absolute; TOP: 8px"
