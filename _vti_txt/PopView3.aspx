<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopView3.aspx.vb" Inherits="Insu.PopView3"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<DIV id="Layer1" style="Z-INDEX: 102; LEFT: 64px; OVERFLOW: scroll; WIDTH: 800px; POSITION: absolute; TOP: 120px; HEIGHT: 750px">
