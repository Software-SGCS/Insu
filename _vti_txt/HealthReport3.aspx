...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:button id="Button1" style="Z-INDEX: 103; LEFT: 152px; POSITION: absolute; TOP: 344px" runat="server"
				Height="24px" Width="144px" Text="Employee List1" Visible="False"></asp:button>
			<asp:button id="Button11" style="Z-INDEX: 130; LEFT: 360px; POSITION: absolute; TOP: 296px"
				runat="server" Text="Recieved Claims Summery" Width="210px" Height="24px"></asp:button>
			...
			<asp:button id="Button7" style="Z-INDEX: 119; LEFT: 152px; POSITION: absolute; TOP: 272px" runat="server"
				Height="24px" Width="184px" Text="New Dependers"></asp:button><asp:imagebutton id="BTT2" style="Z-INDEX: 113; LEFT: 520px; POSITION: absolute; TOP: 104px" runat="server"
				Height="24px" Width="24px" ImageUrl="iCO\Cal1.jpg"></asp:imagebutton><asp:textbox id="TxtTdt" style="Z-INDEX: 112; LEFT: 440px; POSITION: absolute; TOP: 104px" runat="server"
				Height="24px" Width="80px"></asp:textbox><asp:imagebutton id="btt1" style="Z-INDEX: 111; LEFT: 320px; POSITION: absolute; TOP: 104px" runat="server"
				Height="24px" Width="24px" ImageUrl="iCO\Cal1.jpg"></asp:imagebutton><asp:button id="Button5" style="Z-INDEX: 108; LEFT: 360px; POSITION: absolute; TOP: 176px" runat="server"
				Height="24px" Width="210px" Text="Pending Claims"></asp:button><asp:button id="Button4" style="Z-INDEX: 107; LEFT: 152px; POSITION: absolute; TOP: 176px" runat="server"
				Height="24px" Width="184px" Text="Submit Claims"></asp:button><asp:panel id="Panel2" style="Z-INDEX: 105; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				Height="48px" Width="1022px" BackImageUrl="Menu/banner.jpg"></asp:panel><asp:panel id="Panel1" style="Z-INDEX: 104; LEFT: 8px; POSITION: absolute; TOP: 56px" runat="server"
				...
				Height="24px" Width="210px" Text="Recieved Claims"></asp:button><asp:dropdownlist id="LstCom" style="Z-INDEX: 106; LEFT: 144px; POSITION: absolute; TOP: 64px" runat="server"
				Height="32px" Width="401px"></asp:dropdownlist><asp:label id="L1" style="Z-INDEX: 109; LEFT: 936px; POSITION: absolute; TOP: 32px" runat="server"
				Height="16px" Width="93px"></asp:label><asp:textbox id="TxtFdt" style="Z-INDEX: 110; LEFT: 240px; POSITION: absolute; TOP: 104px" runat="server"
				...
				Height="24px" Width="72px">To Date</asp:label><asp:calendar id="Calendar1" style="Z-INDEX: 116; LEFT: 320px; POSITION: absolute; TOP: 104px"
			...
			</asp:calendar><asp:calendar id="Calendar2" style="Z-INDEX: 117; LEFT: 520px; POSITION: absolute; TOP: 104px"
