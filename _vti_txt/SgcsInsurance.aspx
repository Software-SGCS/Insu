<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SgcsInsurance.aspx.vb" Inherits="Insu.SgcsInsurance" %>
							...
							<TD id="cnnNavBar" width="153"><!-- navbar-->
								<UL id="IntlNav">
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('Dispaly1.aspx','800')">Insurance-Vehicle</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 145px; HEIGHT: 16px"><A style="WIDTH: 144px; HEIGHT: 5.89%" href="javascript:loadConsumer('EmpMast.aspx','800')">Vehicles</A></DIV>
									</LI>
									<LI>
										<DIV style="WIDTH: 115px; HEIGHT: 17px"><A style="WIDTH: 144px; HEIGHT: 0.19%" href="javascript:loadConsumer('Entry2.aspx','800')">Pay-Premium
											</A>
										</DIV>
									</LI>
									<LI>
										<DIV><A style="WIDTH: 144px; HEIGHT: 3.09%" href="javascript:loadConsumer('AccidentForm1.aspx','800')">Accident 
												Request </A>
										</DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('AccidentForm1','800')">Accident Payment</A></DIV>
									</LI>
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')">Approval</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('InsuApprovalM.aspx','800')">Certificate</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('PayApprovalNewM.aspx','800')">Pay Notice </A>
										</DIV>
									</LI>
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
									...
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('CrsCertificate.aspx','800')">Certificates</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Crs.aspx','800')">Pay Notice</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('VehReport2.aspx','800')">Certificates-Details</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('VehReport1.aspx','800')">Pay Notice-Details</A></DIV>
									</LI>
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx.aspx','800')">View Docs</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('ViewReport3.aspx','800')">Certificates</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('ViewReport4.aspx','800')">Pay Notice</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
