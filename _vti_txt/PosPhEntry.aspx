<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PosPhEntry.aspx.vb" Inherits="Insu.PosPhEntry" %>
		...
		<form id="Form1" method="post" runat="server">
			<asp:panel id="Panel2" style="Z-INDEX: 106; LEFT: 24px; POSITION: absolute; TOP: -8px" runat="server"
				...
				<asp:label id="Label3" style="Z-INDEX: 101; LEFT: 56px; POSITION: absolute; TOP: 80px" runat="server"
					Height="24px" Width="104px" BackColor="Lavender" Font-Bold="True">Company</asp:label>
				...
				<asp:panel id="Panel5" style="Z-INDEX: 108; LEFT: 864px; POSITION: absolute; TOP: 48px" runat="server"
					Height="498px" Width="112px" BackColor="Desktop" BackImageUrl="Menu/EmpMaster4.jpg"></asp:panel>
			...
			<div id="Layer1" style="Z-INDEX: 101; LEFT: 32px; OVERFLOW: scroll; WIDTH: 812px; POSITION: relative; TOP: 152px; HEIGHT: 304px"><asp:datagrid id="DataGrid1" runat="server" BackColor="White" Width="788px" Height="12px" BorderColor="#3366CC"
					BorderWidth="1px" AutoGenerateColumns="False" BorderStyle="None" CellPadding="4" ShowFooter="True" Font-Size="Small">
					<SelectedItemStyle Font-Bold="True" ForeColor="#CCFF99" BackColor="#009999"></SelectedItemStyle>
					<ItemStyle ForeColor="#003399" BackColor="White"></ItemStyle>
					<HeaderStyle Font-Size="X-Small" Font-Names="Tahoma" Font-Bold="True" ForeColor="#CCCCFF" BackColor="#003399"></HeaderStyle>
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Claim Amount">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:TextBox id="Raw_Soh" runat="server" BackColor="White" Width="90px"></asp:TextBox>
							</ItemTemplate>
						</asp:TemplateColumn>
					</Columns>
