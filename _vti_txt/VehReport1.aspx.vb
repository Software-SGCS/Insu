...
Public Class VehReport1
    ...
    Protected WithEvents TxtRFDt As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtRTDt As System.Web.UI.WebControls.TextBox
    Protected WithEvents Butt2 As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Private Sub ImgBtn3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImgBtn3.Click
        ...
        dd3 = Mid(TxtRFDt.Text, 1, 2) + "/" + Mid(TxtRFDt.Text, 4, 2) + "/" + Mid(TxtRFDt.Text, 7, 4)
        dd4 = Mid(TxtRTDt.Text, 1, 2) + "/" + Mid(TxtRTDt.Text, 4, 2) + "/" + Mid(TxtRTDt.Text, 7, 4)
        ...
        'fdate1 = CDate(Format(dd1, "dd/MM/yyyy"))
        'fdate2 = CDate(Format(dd2, "dd/MM/yyyy"))
        'fdate3 = CDate(Format(dd3, "dd/MM/yyyy"))
        'fdate4 = CDate(Format(dd4, "dd/MM/yyyy"))
        ...
        TxtRFDt.Visible = False
        TxtRTDt.Visible = False
        ...
        ADA = New SqlDataAdapter("SELECT * FROM VehMast WHERE ((((VehMast.Veh_Efdt)>='" & Mid(fdate1, 4, 2) + "/" + Mid(fdate1, 1, 2) + "/" + Mid(fdate1, 7, 4) & "' And (VehMast.Veh_Exdt)<='" & Mid(fdate2, 4, 2) + "/" + Mid(fdate2, 1, 2) + "/" + Mid(fdate2, 7, 4) & "') and ((VehMast.allow2)='" & ss1 & "')) and (((VehMast.Veh_Com) = '" & VehCom11 & "') and ((VehMast.Sold) = 'N'))) or ((((VehMast.Veh_Efdt)>='" & Mid(fdate3, 4, 2) + "/" + Mid(fdate3, 1, 2) + "/" + Mid(fdate3, 7, 4) & "' And (VehMast.Veh_Exdt)<='" & Mid(fdate4, 4, 2) + "/" + Mid(fdate4, 1, 2) + "/" + Mid(fdate4, 7, 4) & "') and ((VehMast.allow2)='" & ss1 & "')) and (((VehMast.Veh_Com) = '" & VehCom11 & "') and ((VehMast.Sold) = 'Y')))" & " order by Id", CON)
        DS = New DataSet
        ...
        For Each Dtr1 In DS.Tables("VehMast1").Rows
            ...
            ss = "INSERT INTO VehmastTemp(Veh_no,Veh_Typ,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_BalAmt,Veh_RefAmt,Sold,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & Vehtyp1 & "','" & VehCom1 & "','" & Vehval1 & "','" & Vehbpay1 & "','" & Vehded1 & "','" & Vehppre1 & "','" & Vehrcc1 & "','" & Vehtr1 & "','" & vehbalamt1 & "','" & vehrefamt1 & "','" & vehsold1 & "','" & VehTot1 & "')"
            ''ss = "INSERT INTO VehmastTemp (VEh_no,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & VehCom1 & "'," & Vehval1 & "," & Vehbpay1 & "," & Vehded1 & "," & Vehppre1 & "," & Vehrcc1 & "," & Vehtr1 & "," & VehTot1 & ")"
        ...
        Dim DSS As VehRep1 = New VehRep1
    ...
    Private Sub TxtFDt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtFDt.TextChanged
        ...
        TxtRFDt.Text = Mid(Format(dtt, "dd/MM/yyyy"), 1, 2) + "/" + Mid(Format(dtt, "dd/MM/yyyy"), 4, 2) + "/" + Mid(Format(dtt, "dd/MM/yyyy"), 7, 4)
        ...
        TxtRTDt.Text = Mid(Format(dtt, "dd/MM/yyyy"), 1, 2) + "/" + Mid(Format(dtt, "dd/MM/yyyy"), 4, 2) + "/" + Mid(Format(dtt, "dd/MM/yyyy"), 7, 4)
        ppp = Mid(Format(dtt, "dd/MM/yyyy"), 1, 2) + "/" + Mid(Format(dtt, "dd/MM/yyyy"), 4, 2) + "/" + Mid(Format(dtt, "dd/MM/yyyy"), 7, 4)

    End Sub


    Private Sub Butt2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Butt2.Click
        '  If Not IsPostBack Then
        Dim DeleteCmd As String = "DELETE from VehmastTemp "
        Dim Cmd As New SqlCommand(DeleteCmd, CON)


        dd1 = Mid(TxtRFDt.Text, 4, 2) + "/" + Mid(TxtRFDt.Text, 1, 2) + "/" + Mid(TxtRFDt.Text, 7, 4)
        dd2 = Mid(TxtRTDt.Text, 4, 2) + "/" + Mid(TxtRTDt.Text, 1, 2) + "/" + Mid(TxtRTDt.Text, 7, 4)
        date1 = (dd1)
        date2 = (dd2)

        fdate1 = Format(date1, "dd/MM/yyyy")
        ss1 = "Approved"
        fdate2 = Format(date2, "dd/MM/yyyy")
        ss = "Select Veh_No,Veh_Com, Veh_Typ,Format(Veh_EfDt,'dd/MM/yyyy') as Veh_EfDt, Format(Veh_Exdt,'dd/MM/yyyy') as Veh_Exdt, Veh_tpay ,Veh_val,ALLOW2,Veh_bpay,Veh_rcc,Veh_tr from VehMast where (((VehMast.Veh_paydt)>=#" & fdate1 & "# And (VehMast.Veh_paydt)<=#" & fdate2 & "#) and ((VehMast.allow1)='" & ss1 & "')) order by id"
        ...
        Dim AAA As String
        VehCom11 = Mid(Trim(LstCom.SelectedValue), 1, 3)
        ADA = New SqlDataAdapter("SELECT * FROM VehMast WHERE (((VehMast.Veh_Efdt)>='" & Mid(fdate1, 4, 2) + "/" + Mid(fdate1, 1, 2) + "/" + Mid(fdate1, 7, 4) & "' And (VehMast.Veh_Exdt)<='" & Mid(fdate2, 4, 2) + "/" + Mid(fdate2, 1, 2) + "/" + Mid(fdate2, 7, 4) & "') and ((VehMast.allow2)='" & ss1 & "')) and ((VehMast.Veh_Com) = '" & VehCom11 & "') and ((VehMast.sold) = 'Y')" & " order by Id", CON)
        DS = New DataSet
        ADA.Fill(DS, "VehMast1")
        ...
        For Each Dtr1 In DS.Tables("VehMast1").Rows
            ...
            vehbalamt1 = IIf(IsDBNull(Dtr1("Veh_balamt")), 0, Dtr1("Veh_balamt"))
            vehsold1 = Dtr1("Sold")
            Vehefdt1 = Format(Dtr1("Veh_EfDt"), "dd/MM/yyyy")
            Vehexdt1 = Format(Dtr1("Veh_Exdt"), "dd/MM/yyyy")
            Vehslddt1 = IIf(IsDBNull(Dtr1("Veh_slddt")), "", Format(Dtr1("Veh_slddt"), "dd/MM/yyyy"))
            Vehefdt1 = Mid(Vehefdt1, 4, 2) + "/" + Mid(Vehefdt1, 1, 2) + "/" + Mid(Vehefdt1, 7, 4)

            Vehexdt1 = Mid(Vehexdt1, 4, 2) + "/" + Mid(Vehexdt1, 1, 2) + "/" + Mid(Vehexdt1, 7, 4)
            ''ss = "INSERT INTO VehmastTemp(VEh_no,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & VehCom1 & "','" & Vehval1 & "','" & Vehbpay1 & "','" & Vehded1 & "','" & Vehppre1 & "','" & Vehrcc1 & "','" & Vehtr1 & "','" & VehTot1 & "')"

            Vehslddt1 = Mid(Vehslddt1, 4, 2) + "/" + Mid(Vehslddt1, 1, 2) + "/" + Mid(Vehslddt1, 7, 4)
        ...
        DSS.PrintOptions.PaperSize = CrystalDecisions.[Shared].PaperSize.Paper11x17
        DSS.PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Portrait
        DSS.SetParameterValue("fdt", "" & Trim(TxtRFDt.Text) & "")
        DSS.SetParameterValue("tdt", "" & Trim(TxtRTDt.Text) & "")
    ...
    Private Sub Butt1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Butt1.Click
        ...
        Dim AAA As String
        VehCom11 = Mid(Trim(LstCom.SelectedValue), 1, 3)
        ADA = New SqlDataAdapter("SELECT * FROM VehMast WHERE (((VehMast.Veh_Efdt)>='" & Mid(fdate1, 4, 2) + "/" + Mid(fdate1, 1, 2) + "/" + Mid(fdate1, 7, 4) & "' And (VehMast.Veh_Exdt)<='" & Mid(fdate2, 4, 2) + "/" + Mid(fdate2, 1, 2) + "/" + Mid(fdate2, 7, 4) & "') and ((VehMast.allow2)='" & ss1 & "')) and ((VehMast.Veh_Com) = '" & VehCom11 & "'" & ") order by VehMast.Veh_typ", CON)
        DS = New DataSet
        ADA.Fill(DS, "VehMast1")
        ...
        For Each Dtr1 In DS.Tables("VehMast1").Rows
            ...
            vehrefamt1 = IIf(IsDBNull(Dtr1("Veh_refamt")), 0, Dtr1("Veh_refamt"))
            vehbalamt1 = IIf(IsDBNull(Dtr1("Veh_balamt")), 0, Dtr1("Veh_balamt"))
            vehsold1 = IIf(IsDBNull(Dtr1("Sold")), "Y", Dtr1("Sold"))
            Vehefdt1 = Format(Dtr1("Veh_EfDt"), "dd/MM/yyyy")
            Vehexdt1 = Format(Dtr1("Veh_Exdt"), "dd/MM/yyyy")
            Vehefdt1 = Mid(Vehefdt1, 4, 2) + "/" + Mid(Vehefdt1, 1, 2) + "/" + Mid(Vehefdt1, 7, 4)
            ...
            If Vehslddt1 = "" Then
                ...
                ss = "INSERT INTO VehmastTemp(Veh_no,Veh_Typ,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_BalAmt,Veh_RefAmt,Sold,Veh_EfDt,Veh_Exdt,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & Vehtyp1 & "','" & VehCom1 & "','" & Vehval1 & "','" & Vehbpay1 & "','" & Vehded1 & "','" & Vehppre1 & "','" & Vehrcc1 & "','" & Vehtr1 & "','" & vehbalamt1 & "','" & vehrefamt1 & "','" & vehsold1 & "','" & Vehefdt1 & "','" & Vehexdt1 & "','" & VehTot1 & "')"
            Else

                Vehslddt1 = Format(Dtr1("Veh_slddt"), "dd/MM/yyyy")
                Vehslddt1 = Mid(Vehslddt1, 4, 2) + "/" + Mid(Vehslddt1, 1, 2) + "/" + Mid(Vehslddt1, 7, 4)
                ''ss = "INSERT INTO VehmastTemp(VEh_no,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & VehCom1 & "','" & Vehval1 & "','" & Vehbpay1 & "','" & Vehded1 & "','" & Vehppre1 & "','" & Vehrcc1 & "','" & Vehtr1 & "','" & VehTot1 & "')"
                ss = "INSERT INTO VehmastTemp(Veh_no,Veh_Typ,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_BalAmt,Veh_RefAmt,Sold,Veh_EfDt,Veh_Exdt,Veh_slddt,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & Vehtyp1 & "','" & VehCom1 & "','" & Vehval1 & "','" & Vehbpay1 & "','" & Vehded1 & "','" & Vehppre1 & "','" & Vehrcc1 & "','" & Vehtr1 & "','" & vehbalamt1 & "','" & vehrefamt1 & "','" & vehsold1 & "','" & Vehefdt1 & "','" & Vehexdt1 & "','" & Vehslddt1 & "','" & VehTot1 & "')"
                ''ss = "INSERT INTO VehmastTemp (VEh_no,Veh_com,Veh_val,Veh_bpay,Veh_ded,veh_ppre,Veh_rcc,Veh_tr,Veh_TotChqPay) VALUES ('" & VehNo1 & "','" & VehCom1 & "'," & Vehval1 & "," & Vehbpay1 & "," & Vehded1 & "," & Vehppre1 & "," & Vehrcc1 & "," & Vehtr1 & "," & VehTot1 & ")"
        ...
        Dim DSS As VehRep2 = New VehRep2
        ...
        DSS.SetDatabaseLogon("sa", "tstc123")
        DSS.PrintOptions.PaperSize = CrystalDecisions.[Shared].PaperSize.PaperLetter
        DSS.PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Portrait
        DSS.SetParameterValue("fdt", "" & Trim(TxtFDt.Text) & "")
        DSS.SetParameterValue("tdt", "" & Trim(TxtTdt.Text) & "")
    ...
    Private Sub TxtRFDt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtRFDt.TextChanged

    End Sub

    Private Sub TxtRTDt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtRTDt.TextChanged
