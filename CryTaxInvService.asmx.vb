...
Public Class CryTaxInvService
    Inherits ReportServiceBase
    
    Public Sub New()
        Me.ReportSource = New CachedWebCryTaxInv(Me)
    End Sub
    ...
    Public Class CachedWebCryTaxInv
        Implements ICachedReport

        Protected webService As CryTaxInvService


        Public Sub New(ByVal webServiceParam As CryTaxInvService)
        ...
        Protected Overridable Function CreateReport() As ReportDocument _
            ...
            Dim report As CryTaxInv = New CryTaxInv()
