...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Count2 = "2" Then
                CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='HelthEntryNewA.aspx' and Form_level2='1'", CON)

            Else
                If Count2 = "3" Then
                    CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='HelthEntryNewA.aspx' and Form_level3='1'", CON)

                Else
                    If Count2 = "4" Then
                        CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='HelthEntryNewA.aspx' and Form_level4='1'", CON)
                    Else
                        If Count2 = "5" Then

                            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='HelthEntryNewA.aspx' and Form_level5='1'", CON)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        CMD.CommandText = ("UPDATE HltMaster1 SET Ver_User1dt='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Ver_User1Time='" & FormatDateTime(TimeOfDay) & "',Ver_User1='" & Trim(L1.Text) & "' where Emp_no='" & Trim(TxtEmpNo.Text) & "' and Emp_com='" & Mid(Trim(Lstcom.SelectedValue), 1, 3) & "' and Emp_Accyr='" & Trim(TxtYr.Text) & "'")
        SS = "UPDATE HltMaster1 SET Ver_User2dt='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Ver_User2Time='" & FormatDateTime(TimeOfDay) & "',Ver_User1='" & Trim(L1.Text) & "' where Emp_no='" & Trim(TxtEmpNo.Text) & "' and Emp_com='" & Mid(Trim(Lstcom.SelectedValue), 1, 3) & "' and Emp_Accyr='" & Trim(TxtYr.Text) & "'"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        CMD.Connection = CON
        'CMD.CommandText = ("UPDATE HltMaster1 SET Raw_Rmk='" & Trim(t9) & "',Tot_ChqAmt=" & Trim(TxtChqAmt.Text) & " where Emp_paydt='" & Trim(t1) & "' and Emp_DecAmt=" & Val(Trim(t4)) & " and Emp_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and  Emp_No=" & Val(Trim(t2)) & " and Emp_Decflg='Yes' and Id=" & Trim(t2))
        CMD.CommandText = ("UPDATE HltMaster1 SET Ver_User2dt='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Ver_User2Time='" & FormatDateTime(TimeOfDay) & "',Ver_User2='" & Trim(L1.Text) & "' where Emp_no='" & Trim(TxtEmpNo.Text) & "' and Emp_com='" & Mid(Trim(Lstcom.SelectedValue), 1, 3) & "' and Emp_Accyr='" & Trim(TxtYr.Text) & "'")
        SS = "UPDATE HltMaster1 SET Ver_User2dt='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Ver_User2Time='" & FormatDateTime(TimeOfDay) & "',Ver_User1='" & Trim(L1.Text) & "' where Emp_no='" & Trim(TxtEmpNo.Text) & "' and Emp_com='" & Mid(Trim(Lstcom.SelectedValue), 1, 3) & "' and Emp_Accyr='" & Trim(TxtYr.Text) & "'"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        CMD.Connection = CON
        'CMD.CommandText = ("UPDATE HltMaster1 SET Raw_Rmk='" & Trim(t9) & "',Tot_ChqAmt=" & Trim(TxtChqAmt.Text) & " where Emp_paydt='" & Trim(t1) & "' and Emp_DecAmt=" & Val(Trim(t4)) & " and Emp_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and  Emp_No=" & Val(Trim(t2)) & " and Emp_Decflg='Yes' and Id=" & Trim(t2))
        CMD.CommandText = ("UPDATE HltMaster1 SET Ver_User3dt='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Ver_User3Time='" & FormatDateTime(TimeOfDay) & "',Ver_User3='" & Trim(L1.Text) & "' where Emp_no='" & Trim(TxtEmpNo.Text) & "' and Emp_com='" & Mid(Trim(Lstcom.SelectedValue), 1, 3) & "' and Emp_Accyr='" & Trim(TxtYr.Text) & "'")
        SS = "UPDATE HltMaster1 SET Ver_User2dt='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Ver_User2Time='" & FormatDateTime(TimeOfDay) & "',Ver_User1='" & Trim(L1.Text) & "' where Emp_no='" & Trim(TxtEmpNo.Text) & "' and Emp_com='" & Mid(Trim(Lstcom.SelectedValue), 1, 3) & "' and Emp_Accyr='" & Trim(TxtYr.Text) & "'"
