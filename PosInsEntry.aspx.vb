...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Count2 = "2" Then
                CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='PosInsEntry.aspx' and Form_level2='1'", CON)

            Else
                If Count2 = "3" Then
                    CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='PosInsEntry.aspx' and Form_level3='1'", CON)

                Else
                    If Count2 = "4" Then
                        CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='PosInsEntry.aspx' and Form_level4='1'", CON)
                    Else
                        If Count2 = "5" Then

                            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='PosInsEntry.aspx' and Form_level5='1'", CON)
    ...
    Private Sub Data4()
        ...
        ss = "Select convert(varchar(10),RelationMaster.Emp_InsDt,103) as Raw_ItmCode,RelationMaster.Emp_No as Raw_des ,RelationMaster.Emp_Reltype as Itm_pri,EmpMaster.Emp_DeathAmt as Raw_opStk,RelationMaster.Emp_InsChqNo as EmpChqNo,RelationMaster.Emp_InsRecdt as EmpCno,RelationMaster.Emp_InsPayAmt as Raw_Soh from RelationMaster ,EmpMaster where RelationMaster.Emp_No=EmpMaster.Emp_No and RelationMaster.Emp_RecFg='N'"
        'Dim cmdCustomers As SqlCommand = New SqlCommand("SELECT RawMaster.Raw_ItmCode as Raw_ItmCode ,RawMaster.Raw_des as Raw_des,ItmMaster.Itm_Pri as Itm_pri,RawMaster.Raw_opStk as Raw_opStk,convert(decimal(7),RawMaster.Raw_Soh,0)  as Raw_Soh,RawMaster.Raw_PhStock as Raw_PhStock FROM RawMaster,ItmMaster WHERE RawMaster.Raw_ItmCode=ItmMaster.Itm_code and  RawMaster.raw_cat='" & Mid(LstCat.SelectedValue, 1, 2) & "' Order by RawMaster.Raw_ItmCode", CON)
        ...
        'Dim cmdCustomers As SqlCommand = New SqlCommand("Select convert(varchar(10),HltMaster1.Emp_PayDt,103) as Emp_Paydt,HltMaster1.Emp_No as Emp_No ,HthMaster.EmployeeName as Emp_Nam,HltMaster1.Emp_DecAmt as Emp_DecAmt,HltMaster1.Emp_Amt as Emp_Amt from HltMaster1 ,HthMaster where HltMaster1.Emp_No=HthMaster.Epfno and HltMaster1.Emp_Com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and HltMaster1.Emp_DecFlg='Yes'", CON)
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select convert(varchar(10),RelationMaster.Emp_InsDt,103) as Raw_ItmCode,RelationMaster.Emp_No as Raw_des ,RelationMaster.Emp_Reltype as Itm_pri,RelationMaster.Emp_DeathAmt as Raw_opStk,RelationMaster.Emp_InsChqNo as EmpChqNo,RelationMaster.Emp_InsRecdt as EmpCno,RelationMaster.Emp_InsPayAmt as Raw_Soh from RelationMaster ,EmpMaster where (RelationMaster.Emp_No=EmpMaster.Emp_No AND RelationMaster.Emp_COM=EmpMaster.Emp_COM) and RelationMaster.Emp_RecFg='N' And RelationMaster.Emp_cOM='" & Mid(Trim(LstCat.SelectedValue), 1, 3) & "'", CON)
    ...
    Private Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        ...
        If e.Item.ItemType.ToString = "Item" Or e.Item.ItemType.ToString = "AlternatingItem" Then
            ...
            t5 = Trim(e.Item.Cells(7).Text)
            t6 = Trim(e.Item.Cells(8).Text)
            t7 = Trim(e.Item.Cells(5).Text)
            ...
            '  Dim chkExp5 As TextBox = e.Item.FindControl("Emp_chqno")
            ' chkExp5.Text = " "
            ' Dim chkExp6 As TextBox = e.Item.FindControl("Emp_cno")
            ' chkExp6.Text = " "
            ' Dim chkExp7 As TextBox = e.Item.FindControl("Raw_Soh")
            ' chkExp7.Text = " "
            '
            ' Dim chkExp8 As TextBox = e.Item.FindControl("Raw_Soh")
            'chkExp6.Text = t8
    ...
    Private Sub BtnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnUpdate.Click
        ...
        'TT = Trim(TT)
        CMD = New SqlCommand("SELECT * FROM HltMaster1", CON)
        ...
        For Each gridrow In DataGrid1.Items
            ...
            ADA = New SqlDataAdapter("SELECT * FROM RelationMaster WHERE Emp_No='" & Trim(t2) & "'", CON)
            DS = New DataSet
            ...
            If count1 <> 0 Then
                ...
                Else
                    CMD.Connection = CON
                    SS = "UPDATE RelationMaster SET Emp_InsPayAmt=" & Trim(t8) & ",Emp_InsChqno='" & Trim(t7) & "',Emp_InsRecDt='" & Mid(Trim(t6), 4, 2) + "/" + Mid(Trim(t6), 1, 2) + "/" + Mid(Trim(t6), 7, 4) & "',Emp_RecFg='Y' where Emp_No='" & Trim(t2) & "' and Emp_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "'"
                    CMD.CommandText = (SS)
                    CMD.ExecuteNonQuery()
                End If
