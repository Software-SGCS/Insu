...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='ViewReport2.aspx' and Form_level='" & Global.PwLevel & "'", CON)
        ...
        CMD = New SqlCommand("SELECT Inv_no From InhInv ", CON)
        DR = CMD.ExecuteReader

        CMD = New SqlCommand("SELECT Inv_no From InhInv where Inv_flag2='Approved' order by Inv_no", CON)
        DR.Close()
        DR = CMD.ExecuteReader
    ...
    Public Sub BindTheGrid()
        ...
        CON.ConnectionString = ("data source=(local);initial catalog=Insu; user id=sa;password=tstc123")
        CON.Open()
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select InhInv.Inv_No,InhInv.Inv_Com, Convert(varchar(10),InhInv.Inv_Dt,103) as InvDt,InhInv.Inv_pono, InhInv.Inv_TotVal as InvTotval, InhInv.Inv_TotQty as InvTotQty,InhInv.Inv_flag2 from InhInv where InhInv.Inv_No>='" & Finvno & "' And InhInv.Inv_No<='" & Tinvno & "' and InhInv.Inv_Flag2='" & ss1 & "'", CON)
    ...
    Public Sub dtgCustomers_Update(ByVal sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        If strfg = "Approved" Then
            ...
            emailMessage.Body = "Inv No :" + strInvNo + " " + strInvCom + " " + " Inv Date :" + strdt + " Approval is Ok" + "      " + "http://sgcsser/Insu/CrsTaxInvoice.aspx"
    ...
    Private Sub dtgCustomers_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub LstFInvNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
