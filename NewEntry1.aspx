	...
	<body bgColor="#f0f8ff" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:dropdownlist id="LstCat" style="Z-INDEX: 100; LEFT: 256px; POSITION: absolute; TOP: 72px" runat="server"
				Width="360px" Height="24px" AutoPostBack="True"></asp:dropdownlist><asp:button id="Button5" style="Z-INDEX: 153; LEFT: 232px; POSITION: absolute; TOP: 176px" runat="server"
				Width="96px" Height="24px" Text="Verify 2" Visible="False"></asp:button><asp:button id="Button4" style="Z-INDEX: 152; LEFT: 128px; POSITION: absolute; TOP: 176px" runat="server"
				Width="88px" Height="24px" Text="Verify 1" Visible="False"></asp:button><asp:textbox id="TxtCrTot" style="Z-INDEX: 150; LEFT: 784px; POSITION: absolute; TOP: 384px"
				runat="server" Width="80px"></asp:textbox><asp:textbox id="TxtBal11" style="Z-INDEX: 148; LEFT: 816px; POSITION: absolute; TOP: 464px"
				runat="server" Width="72px" Height="24px" Visible="False"></asp:textbox><asp:label id="txtmsg" style="Z-INDEX: 147; LEFT: 624px; POSITION: absolute; TOP: 72px" runat="server"
				Width="284px" Height="8px" BackColor="Red" ForeColor="Yellow"></asp:label><asp:textbox id="TxtOldEmpNo4" style="Z-INDEX: 146; LEFT: 816px; POSITION: absolute; TOP: 288px"
				runat="server" Width="64px" Visible="False"></asp:textbox><asp:textbox id="TxtOldEmpNo3" style="Z-INDEX: 145; LEFT: 816px; POSITION: absolute; TOP: 264px"
				runat="server" Width="64px" Visible="False"></asp:textbox><asp:textbox id="TxtOldEmpNo2" style="Z-INDEX: 144; LEFT: 816px; POSITION: absolute; TOP: 240px"
				runat="server" Width="64px" Visible="False"></asp:textbox><asp:label id="Label18" style="Z-INDEX: 139; LEFT: 488px; POSITION: absolute; TOP: 96px" runat="server"
				...
				runat="server" Width="80px" Visible="False"></asp:textbox><asp:label id="Label11" style="Z-INDEX: 124; LEFT: 680px; POSITION: absolute; TOP: 96px" runat="server"
				Width="62px" Height="24px">Acc Year</asp:label><asp:textbox id="TxtYr1" style="Z-INDEX: 123; LEFT: 752px; POSITION: absolute; TOP: 96px" runat="server"
				Width="56px" AutoPostBack="True"></asp:textbox><asp:textbox id="Txtappdt" style="Z-INDEX: 122; LEFT: 648px; POSITION: absolute; TOP: 152px"
				runat="server" Width="88px" ReadOnly="True" Enabled="False"></asp:textbox><asp:textbox id="TxtPay" style="Z-INDEX: 121; LEFT: 472px; POSITION: absolute; TOP: 152px" runat="server"
				Width="88px" ReadOnly="True" Enabled="False"></asp:textbox><asp:label id="Label9" style="Z-INDEX: 120; LEFT: 136px; POSITION: absolute; TOP: 152px" runat="server"
				Width="104px" Height="24px">Treatment Type</asp:label><asp:textbox id="TxtEmpNo" style="Z-INDEX: 116; LEFT: 256px; POSITION: absolute; TOP: 128px"
			...
			<DIV id="Div1" style="Z-INDEX: 115; LEFT: 128px; OVERFLOW: scroll; WIDTH: 680px; POSITION: absolute; TOP: 208px; HEIGHT: 176px"><asp:datagrid id="Datagrid2" runat="server" Width="656px" Height="12px" BackColor="White" BorderColor="#E7E7FF"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="Emp_PayDt" ReadOnly="True" HeaderText="Recieved Date">
							<HeaderStyle Width="1.5in"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						...
						<asp:BoundColumn DataField="Emp_RecDt" HeaderText="Submit Date">
							<HeaderStyle Width="1.5in"></HeaderStyle>
							<ItemStyle HorizontalAlign="Left"></ItemStyle>
						</asp:BoundColumn>
					</Columns>
			...
			<div id="Layer1" style="Z-INDEX: 102; LEFT: 120px; OVERFLOW: scroll; WIDTH: 678px; POSITION: relative; TOP: 392px; HEIGHT: 115px"><asp:datagrid id="DataGrid1" runat="server" Width="656px" Height="12px" BackColor="White" BorderColor="#E7E7FF"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Treatment Type">
							<HeaderStyle Width="2in"></HeaderStyle>
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:Label id="Itm_Pri" runat="server" Width="82px">Label</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
			...
			<asp:textbox id="TxtChqAmt" style="Z-INDEX: 140; LEFT: 584px; POSITION: absolute; TOP: 96px"
			...
			<asp:panel id="Panel8" style="Z-INDEX: 106; LEFT: 8px; POSITION: absolute; TOP: 48px" runat="server"
				Width="1056px" Height="16px" BackColor="Navy"></asp:panel><asp:textbox id="TxtCno" style="Z-INDEX: 110; LEFT: 416px; POSITION: absolute; TOP: 96px" runat="server"
				Width="64px"></asp:textbox><asp:textbox id="TxtChqNo" style="Z-INDEX: 112; LEFT: 256px; POSITION: absolute; TOP: 96px" runat="server"
				Width="72px" AutoPostBack="True"></asp:textbox><asp:label id="Label5" style="Z-INDEX: 111; LEFT: 136px; POSITION: absolute; TOP: 96px" runat="server"
				Width="88px" Height="24px">Cheque No</asp:label><asp:label id="Label6" style="Z-INDEX: 113; LEFT: 336px; POSITION: absolute; TOP: 96px" runat="server"
				Width="72px" Height="24px">Claim No</asp:label><asp:label id="Label8" style="Z-INDEX: 117; LEFT: 136px; POSITION: absolute; TOP: 128px" runat="server"
				Width="88px" Height="24px">EmpNo</asp:label><asp:textbox id="TxtNam" style="Z-INDEX: 118; LEFT: 344px; POSITION: absolute; TOP: 128px" runat="server"
				Width="280px" Height="24px"></asp:textbox><asp:dropdownlist id="Lsttyp" style="Z-INDEX: 119; LEFT: 256px; POSITION: absolute; TOP: 152px" runat="server"
				...
				Width="80px" Text="Update"></asp:button><asp:button id="Button2" style="Z-INDEX: 127; LEFT: 768px; POSITION: absolute; TOP: 160px" runat="server"
				Width="56px" Height="24px" Visible="False" Enabled="False" Text="Insert"></asp:button><asp:label id="Label10" style="Z-INDEX: 128; LEFT: 400px; POSITION: absolute; TOP: 152px" runat="server"
				Width="64px" Height="24px">Value</asp:label><asp:label id="Label12" style="Z-INDEX: 129; LEFT: 576px; POSITION: absolute; TOP: 152px" runat="server"
				Width="64px" Height="24px">Date</asp:label><asp:label id="Label13" style="Z-INDEX: 130; LEFT: 648px; POSITION: absolute; TOP: 176px" runat="server"
				...
				Width="72px" Height="24px"></asp:textbox><asp:label id="Label14" style="Z-INDEX: 134; LEFT: 136px; POSITION: absolute; TOP: 384px" runat="server"
				...
				runat="server" Width="88px"></asp:textbox><asp:label id="Label19" style="Z-INDEX: 141; LEFT: 640px; POSITION: absolute; TOP: 128px" runat="server"
				Width="88px" Height="24px">Chq Bal Amt</asp:label><asp:textbox id="Txtbal" style="Z-INDEX: 142; LEFT: 744px; POSITION: absolute; TOP: 128px" runat="server"
				Width="96px" Height="24px" ForeColor="Red" ReadOnly="True" Font-Size="Larger" Font-Bold="True"></asp:textbox><asp:textbox id="TxtOldEmpNo1" style="Z-INDEX: 143; LEFT: 816px; POSITION: absolute; TOP: 216px"
				runat="server" Width="64px" Visible="False"></asp:textbox><asp:label id="L1" style="Z-INDEX: 114; LEFT: 128px; POSITION: absolute; TOP: 568px" runat="server"
				Width="121px" Height="24px"></asp:label><asp:textbox id="TxtOutTot" style="Z-INDEX: 132; LEFT: 432px; POSITION: absolute; TOP: 384px"
				runat="server" Width="80px"></asp:textbox><asp:textbox id="TxtInTot" style="Z-INDEX: 133; LEFT: 616px; POSITION: absolute; TOP: 384px"
				runat="server" Width="72px"></asp:textbox><asp:label id="Label20" style="Z-INDEX: 149; LEFT: 696px; POSITION: absolute; TOP: 384px" runat="server"
				Width="88px" Height="16px">Criticle Total</asp:label></form>
	</body>
</HTML>
