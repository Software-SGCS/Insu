...
#End Region
    ...
    Public Sub dtgCustomers_Update(ByVal sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        If strfg = "Approved" Then
            ...
            emailMessage.Body = "Inv No :" + strInvNo + " " + strInvCom + " " + " Inv Date :" + Mid(strdt, 4, 2) + "/" + Mid(strdt, 1, 2) + "/" + Mid(strdt, 7, 4) + " For Approval" + "      " + "http://sgcsser/Insu/InvApproval.aspx"
        ...
        Else
            If strfg = "Not Approved" Then
                ...
                emailMessage.Body = "Inv No :" + strInvNo + " " + strInvCom + " " + " Inv Date :" + Mid(strdt, 4, 2) + "/" + Mid(strdt, 1, 2) + "/" + Mid(strdt, 7, 4) + " Invoce is not Ok"
