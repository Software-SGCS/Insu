...
#End Region
    ...
    Private Sub Data4()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select EmpMaster.EmpAct as Raw_ItmCode,EmpMaster.Emp_No as Raw_Rec,EmpMaster.Emp_No as Raw_des ,EmpMaster.Emp_Nam as Itm_pri,EmpMaster.OldEpfNo as Raw_opStk,EmpMaster.EmpAct as  Raw_PhStock,EmpMaster.EmpDel as Raw_Soh from EmpMaster where EmpMaster.Emp_Com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and EmpDel='N' and EmpAct='N' ORDER BY EmpMaster.Emp_No", CON)
