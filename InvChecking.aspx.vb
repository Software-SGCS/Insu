...
Public Class InvChecking
    ...
    Dim Invno1, InvCom1, Invdt1, InvFlag11, InvPono1, InvItmNo1, InvQty1, InvVal1, InvPri1, Invvat1 As String
    Public ss As String
    Dim body As String
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='InvChecking.aspx' and Form_level='" & Global.PwLevel & "'", CON)
    ...
    Public Sub BindTheGrid()
        ...
        objConn.Open()
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select Inv_No,Inv_Com, Format(Inv_Dt,'dd/MM/yyyy') as InvDt,Inv_pono, Format(Inv_TotVal,'#,###.00') as Inv_TotVal, Format(Inv_TotQty,'###') as Inv_TotQty,Inv_flag1 from InhInv where Inv_flag1='Select'", objConn)
    ...
    Public Sub dtgCustomers_Update(ByVal sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        If strfg = "Approved" Then
            ...
            End Try
            'body += "<table width='752' border='0'>"
            'body += "<tr>"
            'body += "<td width='16' height='40'>&nbsp;</td>"
            'body += "<td width='636'><form id='form2' name='form2' method='post' action=''>"
            'body += "<label>"
            'body += "<input type='image' name='imageField' src='file:///C|/Documents and Settings/Administrator/Desktop/Insu/Menu/BANN2.jpg' />"
            'body += "</label>"
            'body += "</form>"
            'body += "</td>"
            'body += "<td width='86'>&nbsp;</td>"
            'body += "</tr>"
            'body += "<tr>"
            'body += "<td height='174'>&nbsp;</td>"
            'body += "<td><form id='form1' name='form1' method='post' action=''>"
            'body += "<table width='517' height='130' border='0'>"
            'body += "<tr>"
            'body += "<td><label>Invoice No</label></td>"
            'body += "<td>" & strInvNo & "</td>"
            'body += "<td>&nbsp;</td>"
            'body += "</tr>"
            'body += "<tr>"
            'body += "<td width='80'><label>Company</label></td>"
            'body += "<td width='309'>" & strInvCom & "<input type='text' name='txtNam' /></td>"
            'body += "<td width='106'>&nbsp;</td>"
            'body += "</tr>"
            'body += "<tr>"
            'body += "<td><label>Total Value</label></td>"
            'body += "<td><input type='text' name='txtVal' /></td>"
            'body += "<td>&nbsp;</td>"
            'body += "</tr>"
            'body += "<tr>"
            'body += "<td><label>Total Qty </label></td>"
            'body += "<td><input type='text' name='txtQty' /></td>"
            'body += "<td>&nbsp;</td>"
            'body += "</tr>"
            'body += "</table>"
            'body += "<label></label>"
            ...
            'body += "</tr>"
            'body += "<tr>"
            'body += "<td height='39'>&nbsp;</td>"
            'body += "<td>Appro</td>"
            'body += "<td>&nbsp;</td>"
            'body += "</tr>"
            'body += "</table>"

            body += "<table width='1071' border='0'>"
            body += "<tr>"
            body += "<td width='186' height='40'><form id='form3' name='form3' method='post' action=''>"
            body += "<label></label>"
            body += "<label></label>"
            body += "<label></label>"
            body += "<label>"
            body += "<input type='image' name='imageField3' src='../../../Inetpub/wwwroot/Insu/imgs/logo.cnn.com.gif' />"
            body += "</label>"
            body += "</form>    </td>"
            body += "<td width='748'><form id='form2' name='form2' method='post' action=''>"
            body += "<label></label>"
            body += "<label></label>"
            body += "<label></label>"
            body += "<input type='image' name='imageField' src='../../../Inetpub/wwwroot/Insu/Menu/BANNER.jpg' />"
            body += "</form>    </td>"
            body += "<td width='123'>&nbsp;</td>"
            body += "</tr>"
            body += "<tr>"
            body += "<td height='174'><form id='form4' name='form4' method='post' action=''>"
            body += "<label>"
            body += "<input type='image' name='imageField2' src='../../../Inetpub/wwwroot/Insu/Menu/Audit.gif' />"
            body += "</label>"
            body += "</form>    </td>"
            body += "<td><form id='form1' name='form1' method='post' action=''>"
            body += "<table width='517' height='130' border='0'>"
            ...
            body += "<tr>"
            body += "<td width='80'><label>Company</label></td>"
            body += "<td width='309'>" & strInvCom & "</td>"
            body += " <td width='106'>&nbsp;</td>"
            body += " </tr>"
            body += "<tr>"
            body += "<td><label>Total Value</label></td>"
            ...
            body += "</tr>"
            body += "<tr>"
            body += "<td height='21'>&nbsp;</td>"
            body += "<td>&nbsp;</td>"
            body += "<td>&nbsp;</td>"
            body += "</tr>"
            body += "<tr><td align='left' colSpan='2'><form method='post' action=http://sgcsser/crm/frmSecAppEmail.aspx?TYPE=NMAN756 name='frm1'><input name='sbb' type='image' src='../../../Inetpub/wwwroot/Insu/Menu/approve.jpg' width='163' height='47'>"
            body += "</form>"
            ...
            body += "<td align='left' colSpan='2'><form method='post' action=http://sgcsser/crm/frmSecAppEmail.aspx?TYPE=NMAN756 name='frm1'><input name='sbb1' type='image' src='../../../Inetpub/wwwroot/Insu/Menu/NotApprove.jpg' width='163' height='47'></form>"

            body += "</td>"


            body += "<td align='left' colSpan='2'><form method='post' action=http://sgcsser/crm/frmSecAppEmail.aspx?TYPE=NMAN756 name='frm1'><input name='sbb2' type='image' src='../../../Inetpub/wwwroot/Insu/Menu/view1.jpg' width='163' height='47'></form>"
            ...
            Try
                ...
                msg.From = "palithan@samsoncorporates.com"

                msg.To = "palithan@samsoncorporates.com"

                msg.Bcc = "palithan@samsoncorporates.com" '"thusitha@dsisamson.com"
            ...
            'emailMessage.Cc = "palithan@samsoncorporates.com"
            'emailMessage.Bcc = "palithan@samsoncorporates.com"
