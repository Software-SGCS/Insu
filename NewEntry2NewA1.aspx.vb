...
#End Region
    ...
    Private Sub Data4()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select HthMaster.EmpAct as Raw_ItmCode,HthMaster.Epfno as Raw_SOH,HthMaster.Epfno as Raw_des ,HthMaster.EmployeeName as Itm_pri,HthMaster.OldEpfNo as Raw_opStk,HthMaster.EmpAct as  Raw_PhStock,HthMaster.Epfno as Raw_rec from HthMaster where HthMaster.Com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' AND (HthMaster.EmpAct='N') ORDER BY STR(HthMaster.Epfno)", CON)
    ...
    Private Sub ButSub_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButSub.Click
        ...
        For Each gridrow In DataGrid1.Items
            ...
            If Trim(t1) <> Trim(t6) Then
                ...
                CMD.CommandText = ("UPDATE HthMaster SET EmpAct='" & t6 & "',Act_Code='" & Trim(L1.Text) & "',Act_time='" & FormatDateTime(TimeOfDay) & "',Act_Date='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Act_Act='" & Trim(t6) & "' where EpfNo='" & Trim(t2) & "' and Com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "'")
                CMD.ExecuteNonQuery()
