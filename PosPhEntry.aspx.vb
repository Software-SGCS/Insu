...
#End Region
    ...
    Private Sub Data4()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select convert(varchar(10),RelationMaster.Emp_InsDt,103) as Raw_ItmCode,RelationMaster.Emp_No as Raw_des ,EmpMaster.Emp_Nam as Itm_pri,RelationMaster.Emp_Nam as Raw_opStk,RelationMaster.Emp_ChqNo as EmpChqNo,RelationMaster.Emp_Paydt as EmpCno,RelationMaster.Emp_DeathAmt as Raw_Soh from RelationMaster ,EmpMaster where (RelationMaster.Emp_No=EmpMaster.Emp_No AND RelationMaster.Emp_COM=EmpMaster.Emp_COM)  and (RelationMaster.Emp_InsFg='Y' and RelationMaster.Cer_flag='Y') And RelationMaster.Emp_cOM='" & Mid(Trim(LstCat.SelectedValue), 1, 3) & "'", CON)
        ...
        For Each gridrow In DataGrid1.Items
            ...
            If count1 <> 0 Then
                ...
                Else
                    ...
                    CMD.CommandText = ("UPDATE RelationMaster SET Emp_DeathAmt=" & Trim(t8) & ",Emp_Chqno='" & Trim(t7) & "',Emp_PayDt='" & Mid(Trim(t6), 4, 2) + "/" + Mid(Trim(t6), 1, 2) + "/" + Mid(Trim(t6), 7, 4) & "',Emp_InsFg='N' where Emp_No='" & Trim(t2) & "' and Emp_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and Emp_Nam='" & Trim(t4) & "' and Emp_InsFg='Y'")
                    CMD.ExecuteNonQuery()
                End If
