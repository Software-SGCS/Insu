...
#End Region
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select INHPUR.Inv_No as InvNo ,INHPUR.Inv_Com as Invcom ,Supplier.com_nam as comnam, convert(varchar(10),INHPUR.Inv_Dt,103) as InvDt,convert(varchar(10),INHPUR.Inv_Pdt,103) as PayDt,INHPUR.Inv_pono as Invpono,  INHPUR.Inv_TotQty as InvTotQty,datevalue('" & today1 & "')-[InhPur]![Inv_Dt] as InvDays ,INHPUR.Inv_flag1 as invflag1 from INHPUR,Supplier where INHPUR.Inv_com=Supplier.com_no and INHPUR.Inv_ChqNo='*****' and datevalue('" & today1 & "')-[InhPur]![Inv_Dt]>=Supplier.com_Chqlmt ", objConn)
