<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PosInsEntry.aspx.vb" Inherits="Insu.PosInsEntry" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<DIV style="Z-INDEX: 107; LEFT: 16px; WIDTH: 944px; POSITION: absolute; TOP: 8px; HEIGHT: 24px"
				align="left" ms_positioning="FlowLayout"><FONT face="Tahoma"><FONT size="5"><FONT size="4">&nbsp;Entry&nbsp;DDF 
							Payment&nbsp;From Insurance Company</FONT></FONT></FONT></DIV>
			<div id="Layer1" style="Z-INDEX: 101; LEFT: 42px; OVERFLOW: scroll; WIDTH: 828px; POSITION: relative; TOP: 104px; HEIGHT: 360px"><asp:datagrid id="DataGrid1" runat="server" BackColor="White" Width="788px" Height="2px" BorderColor="#E7E7FF"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Relation Type">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:Label id="Itm_Pri" runat="server" Width="114px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="Company Amt">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
						...
						<asp:TemplateColumn HeaderText="Rec Date">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:TextBox id="EmpCno" runat="server" Width="82px" BackColor="White"></asp:TextBox>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="Recived  Amt">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
