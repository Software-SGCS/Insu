...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            ' CMD = New SqlCommand("SELECT Veh_no,Veh_com FROM VehMast where veh_no<>'' and Veh_CertifyNo<>' ' and allow1='Approved' and allow2='Approved' and SOLD='N' ORDER BY  Veh_Com,veh_no", CON)
            CMD = New SqlCommand("SELECT Veh_no,Veh_com FROM VehMast where veh_no<>'' and Veh_CertifyNo<>'' and SOLD='N' ORDER BY  Veh_Com,veh_no", CON)
            ...
            If Not IsPostBack Then
                ...
                While DR.Read
                    TT = Trim(DR.GetValue(1)) + "-" + DR.GetValue(0)
                    LstId.Items.Add(TT)
                End While
            End If
            DR.Close()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        vehno1 = Trim(Mid(LstId.SelectedValue, 5, 20))
