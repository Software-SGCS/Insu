<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NewEntry2.aspx.vb" Inherits="Insu.NewEntry2" %>
	...
	<body bgColor="#f0f8ff" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:dropdownlist id="LstCat" style="Z-INDEX: 101; LEFT: 256px; POSITION: absolute; TOP: 72px" runat="server"
				...
				Height="57px" Width="1056px" BackColor="Navy"></asp:panel><asp:panel id="Panel10" style="Z-INDEX: 109; LEFT: 1000px; POSITION: absolute; TOP: 64px" runat="server"
				Height="400px" Width="64px" BackColor="Navy"></asp:panel><asp:panel id="Panel9" style="Z-INDEX: 108; LEFT: 8px; POSITION: absolute; TOP: 0px" runat="server"
				...
				Height="589px" Width="96px" BackColor="Navy"></asp:panel><asp:label id="Company" style="Z-INDEX: 102; LEFT: 120px; POSITION: absolute; TOP: 72px" runat="server"
				Height="24px" Width="104px">Company</asp:label>
			<DIV id="Layer1" style="Z-INDEX: 103; LEFT: 112px; OVERFLOW: scroll; WIDTH: 824px; POSITION: relative; TOP: 104px; HEIGHT: 328px"><asp:datagrid id="DataGrid1" runat="server" Height="60px" Width="776px" BackColor="White" Font-Size="Small"
					ShowFooter="True" GridLines="Horizontal" CellPadding="3" BorderStyle="None" AutoGenerateColumns="False" BorderWidth="1px" BorderColor="#E7E7FF">
					...
					<Columns>
						...
						<asp:TemplateColumn Visible="False" HeaderText="Submit Date">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:Label id="Raw_ItmCode" runat="server" Height="16px" Width="100px">Label</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="Employee #">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:Label id="Raw_des" runat="server" Width="100px" Height="16px">Label</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						...
						<asp:TemplateColumn HeaderText="Old EpfNo">
							<ItemStyle Font-Size="X-Small" Font-Names="Tahoma"></ItemStyle>
							<ItemTemplate>
								<asp:Label id="Raw_OpStk" runat="server" Width="100px">Label</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
			...
			<asp:panel id="Panel6" style="Z-INDEX: 106; LEFT: 112px; POSITION: absolute; TOP: 16px" runat="server"
			...
			<asp:Label id="L1" style="Z-INDEX: 115; LEFT: 784px; POSITION: absolute; TOP: 472px" runat="server"
				Height="24px" Width="104px"></asp:Label>
			<asp:button id="ButSub" style="Z-INDEX: 104; LEFT: 744px; POSITION: absolute; TOP: 80px" runat="server"
