<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PettyCash.aspx.vb" Inherits="Insu.PettyCash" %>
							...
							<TD id="cnnNavBar" width="153"><!-- navbar-->
								<UL id="IntlNav">
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('Dispaly1.aspx','800')">PttyCash</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')"></A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PrettyCashAdd.aspx','900')">Change 
												Cash In Box</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')"></A></DIV>
									...
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PrettyCashOutword.aspx','900')">Pending 
												Vouchers Entry</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PrettyCashInword.aspx','900')">Payment 
												Vouchers Entry</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')"></A></DIV>
									...
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PettyCashReq.aspx','900')">Fund 
												Request Entry</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PrettyCashRec.aspx','900')">Receivecd 
												Fund </A>
										</DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PrettyCashAddCash.aspx','900')">Cash 
												Receivecd From Import </A>
										</DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')"></A></DIV>
									...
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('PettyCashReport1.aspx','900')">Report</A>
										</DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')"></A></DIV>
									...
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Display1.aspx','800')">Reports</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')"></A></DIV>
									</LI>
