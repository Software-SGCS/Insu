...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            For Each Dtr1 In DS.Tables("INHINV1").Rows
                ...
                StrInvFlag1 = Dtr1("Inv_Flag1")
                StrInvFlag2 = Dtr1("Inv_Flag2")
                invtt1 = Dtr1("Inv_Tt")
                Invvat1 = Dtr1("Inv_Flg")

                If StrInvFlag1 = "Approved" Then
                    Button1.Text = "Approved on " + Format(Dtr1("inv_cdt"), "dd/MM/yyyy")
                    Button1.Enabled = False
                    Button3.Enabled = False
                    Button3.Text = "               "

                Else
                    If StrInvFlag1 = "Not Approved" Then
                        Button3.Text = "Not Approved on " + Format(Dtr1("inv_ncdt"), "dd/MM/yyyy")
                    End If
                End If
                ...
                For Each Dtr In DS.Tables("InlInv1").Rows
                    ...
                    'Cmd.CommandText = ("INSERT INTO TempInv (Inv_no,Inv_Com,Inv_dt,Inv_flag1,Inv_pono,Inv_ItmNo,Inv_Qty,Inv_val,Inv_pri,Inv_cat,Inv_qtyt,Inv_dis) VALUES ('" & Invno1 & "','" & InvCom1 & "',#" & Invdt1 & "#,'" & InvFlag11 & "','" & InvPono1 & "','" & InvItmNo1 & "','" & InvQty1 & "','" & InvVal1 & "','" & InvPri1 & "','" & InvCat & "','" & invqty11 & "','" & Invdis1 & "')")
                    Cmd.CommandText = ("INSERT INTO TempInv (Inv_no,Inv_Com,Inv_dt,Inv_flag1,Inv_pono,Inv_ItmNo,Inv_Qty,Inv_val,Inv_pri,Inv_cat,Inv_qtyt,Inv_flag3,Inv_per,Inv_tt,Inv_flg,Inv_dis) VALUES ('" & Invno1 & "','" & InvCom1 & "','" & Mid(Invdt1, 1, 2) + "/" + Mid(Invdt1, 4, 2) + "/" + Mid(Invdt1, 7, 4) & "','" & InvFlag11 & "','" & InvPono1 & "','" & InvItmNo1 & "','" & InvQty1 & "','" & InvVal1 & "','" & InvPri1 & "','" & InvCat & "','" & invqty11 & "','" & Invflag31 & "','" & invper1 & "','" & invtt1 & "','" & Invvat1 & "','" & Invdis1 & "')")
                    Cmd.ExecuteNonQuery()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If StrInvFlag1 = "Not Approved" Then
            strSql = "UPDATE InhInv SET Inv_Flag1='" & strfg & "',Inv_Flag2= 'Select',Inv_cdt='" & Mid(Todt, 4, 2) + "/" + Mid(Todt, 1, 2) + "/" + Mid(Todt, 7, 4) & "' WHERE Inv_Flag1='Not Approved' and Inv_No='" & strInvNo & "'"
        Else
            strSql = "UPDATE InhInv SET Inv_Flag1='" & strfg & "',Inv_Flag2= 'Select',Inv_cdt='" & Mid(Todt, 4, 2) + "/" + Mid(Todt, 1, 2) + "/" + Mid(Todt, 7, 4) & "' WHERE Inv_Flag1='Select' and Inv_No='" & strInvNo & "'"
        End If
        ...
        BODY += "<td><form method='post' action=http://sgcsser/Insu/InvApproval.aspx name='frm1'><input name='sbb1' type='image' src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/AppAll.jpg' width='100' height='30'> </form></td>"
        BODY += "</tr>"
        BODY += "</table>"
        BODY += "</td>"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        strfg = "Not Approved"
        strSql = "UPDATE InhInv SET Inv_Flag1='" & strfg & "',Inv_Flag2= 'Select',Inv_ncdt='" & Mid(Todt, 4, 2) + "/" + Mid(Todt, 1, 2) + "/" + Mid(Todt, 7, 4) & "' WHERE Inv_Flag1='Select' and Inv_No='" & strInvNo & "'"
        cmdCustomers = New SqlCommand(strSql, CON)
        ' objConn.Open()
        cmdCustomers.ExecuteReader(CommandBehavior.CloseConnection)
        CON = New SqlConnection
        ...
        BODY += "<label></label>"
        BODY += "<label>"
        BODY += "<input type='image' name='imageField3' src='imgs/logo.cnn.com.gif' />"
        BODY += "</label>"
        BODY += "</form>    </td>"
        BODY += "<td width='750'><form id='form2' name='form2' method='post' action=''>"
        BODY += "<label></label>"
        ...
        BODY += "<label></label>"
        BODY += " <label>"
        BODY += "<input type='image' name='imageField7' src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question1.jpg' />"
        BODY += "</label>"
        BODY += "</form>    </td>"
        BODY += "<td><form id='form1' name='form1' method='post' action=''>"
        BODY += "<table width='525' height='151' border='0'>"
        BODY += "<tr>"
        BODY += "<td height='33'><label>Invoice No</label></td>"
        BODY += "<td>" & strInvNo & "</td>"
        BODY += " <td>&nbsp;</td>"
        ...
        BODY += "</table>"
        BODY += "<img src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question14.jpg' width='107' height='107' />"
        BODY += "<img src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question11.jpg' width='116' height='102' />"
        BODY += "<img src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question4.jpg' width='103' height='127' /><img src='../../../Inetpub/wwwroot/Insu/Menu/question8.jpg' width='94' height='129' />"
        BODY += " <table width='200' border='0'>"
        BODY += "<tr><img src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question12.jpg' />"
        BODY += "<td>&nbsp;</td>"
        BODY += "</tr>"
        BODY += "</table>"
        BODY += "<label></label>"
        ...
        BODY += "<tr><td align='left' colSpan='2'><table width='183' border='0'>"
        BODY += " <tr>"
        BODY += "<td width='100'><form method='post' action=http://sgcsser/Insu/NewApp5.aspx?TYPE=" & strInvNo & " name='frm1'><input name='sbb1' type='image' src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question13.jpg' width='100' height='30'> </form></td>"
        BODY += "</form></td>"
        BODY += "<td width='1'>&nbsp;</td>"
        BODY += "<td width='68'>&nbsp;</td>"
        BODY += "</tr>"
        ...
        ''emailMessage.To = "palithan@samsoncorporates.com"
        emailMessage.Subject = "Inv No :" + strInvNo + " " + StrInvcom + " " + " Inv Date :" + Strdt + " Invoice in Not Ok Pls Correct it" + " "
