...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Count2 = "2" Then
                CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation22.aspx' and Form_level2='1'", CON)

            Else
                If Count2 = "3" Then
                    CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation22.aspx' and Form_level3='1'", CON)

                Else
                    If Count2 = "4" Then
                        CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation22.aspx' and Form_level4='1'", CON)
                    Else
                        If Count2 = "5" Then

                            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='DeathDonation22.aspx' and Form_level5='1'", CON)
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select Id,Emp_Nam,Emp_RelType,Emp_InsPayAmt as Emp_InsPayAmt, Convert(Varchar(10),Emp_InsDt,103) as Emp_InsDt,Convert(Varchar(10),Emp_InsRecDt,103) as Emp_InsRecDt,Emp_Inschqno from RelationMaster where emp_No='" & Trim(TempEmpno) & "' and Emp_Com='" & Trim(TempCom) & "'", CON)


        'Dim cmdCustomers As SqlCommand = New SqlCommand("Select * from RelationMaster where emp_No='" & Trim(TempEmpno) & "' and Emp_Com='" & Trim(TempCom) & "'", CON)
    ...
    Private Sub BttIns_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttIns.Click
        ...
        SEmpNam = Trim(LstRNam.SelectedValue)
        ...
        CMD.CommandText = ("INSERT INTO RelationMaster(Emp_No,Emp_Com,Emp_Nam,Emp_Reltype,Emp_Dob,Emp_DeathAmt,Emp_PayDt,Emp_Chqno,Emp_DeathFlag) VALUES ('" & SEmpno & "','" & SEmpcom & "','" & SEmpNam & "','" & SEmpRetype & "','" & Mid(SEmpDod, 4, 2) + "/" + Mid(SEmpDod, 1, 2) + "/" + Mid(SEmpDod, 7, 4) & "'," & SEmpDeathAmt & ",'" & Mid(SEmpPayDt, 4, 2) + "/" + Mid(SEmpPayDt, 1, 2) + "/" + Mid(SEmpPayDt, 7, 4) & "','" & SEmpChqNo & "','" & SEmpFlag & "')")
        CMD.ExecuteNonQuery()
