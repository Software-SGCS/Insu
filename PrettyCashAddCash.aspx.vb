...
Public Class PrettyCashAddCash
    ...
    Dim str1, str2, des1, des2 As String
    Dim q, r, s As String
    Dim p, t, tot1 As Double
    Dim InvFlag2 As String
    Dim count1, count, count2, count3, i, j, rowCount As Integer
    Dim depno As String
    ...
    Protected WithEvents TxtPedAmt As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtPedAmt1 As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub BindTheGrid2()
        ...
        SS = "Select  id,Out_Vno AS Raw_ItmCode,Out_Vno AS Vou_No,Out_Eno as Raw_des, REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,Out_Amt),1), '','') as Mas_BnkCode, Convert(Varchar(10),Out_Date,103) as Mas_InTrm,Out_Amt as Mas_Amt from OutWord where Out_Flg='Y' and Typ='1'"
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand(SS, CON1)
        cmdCustomers.CommandType = CommandType.Text
    ...
    Private Sub BtnSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        ...
        TxtPedAmt.Text = Val(tot1)
        TxtPedAmt1.Text = Val(tot1)
        TxtPedAmt.Text = "        " + Format(tot1, "###,###,###.00")
        If Val(TxtAmt1.Text) = Val(TxtPedAmt1.Text) Then
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        ADA = New SqlDataAdapter("SELECT  Vou_Date from CashBoxEnd where Typ='2' and Vou_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'", CON1)
        ...
        q8 = -1 * Val(TxtQ8.Text)
        q9 = -1 * Val(TxtQ9.Text)
        q10 = -1 * Val(TxtQ10.Text)
        q11 = -1 * Val(TxtQ11.Text)

        If count2 = 0 Then
            CMD.CommandText = ("INSERT INTO CashBoxEnd(Vou_Date,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,typ)VALUES('" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'," & q1 & "," & q2 & "," & q3 & "," & q4 & "," & q5 & "," & q6 & "," & q7 & "," & q8 & "," & q9 & "," & q10 & "," & q11 & ",'2')")
            SS = "INSERT INTO CashBoxEnd(Vou_Date,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,typ)VALUES('" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'," & q1 & "," & q2 & "," & q3 & "," & q4 & "," & q5 & "," & q6 & "," & q7 & "," & q8 & "," & q9 & "," & q10 & "," & q11 & ",'2')"
            CMD.ExecuteNonQuery()
        Else
            CMD.CommandText = ("UPDATE CashBoxEnd SET Q1=Q1+" & q1 & ",Q2=Q2+" & q2 & ",Q3=Q3+" & q3 & ",Q4=Q4+" & q4 & ",Q5=Q5+" & q5 & ",Q6=Q6+" & q6 & ",Q7=Q7+" & q7 & ",Q8=Q8+" & q8 & ",Q9=Q9+" & q9 & ",Q10=Q10+" & q10 & ",Q11=Q11+" & q11 & ",typ='2' where Typ='2' and Vou_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'")
        ...
        CMD.Connection = CON1
        CMD.CommandText = ("INSERT INTO AddCash(Cash_dt,Cash_Time,Ref,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,Amt,Typ,Com) VALUES ('" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & SS & "','" & TxtDes.Text & "','" & Trim(TxtQ1.Text) & "','" & Trim(TxtQ2.Text) & "','" & Trim(TxtQ3.Text) & "','" & Trim(TxtQ4.Text) & "','" & Trim(TxtQ5.Text) & "','" & Trim(TxtQ6.Text) & "','" & Trim(TxtQ7.Text) & "','" & Trim(TxtQ8.Text) & "','" & Trim(TxtQ9.Text) & "','" & Trim(TxtQ10.Text) & "','" & Trim(TxtQ11.Text) & "','" & Trim(TxtAmt1.Text) & "','1','TRA')")
        ...
        '-----Import
        CMD.Connection = CON1
        CMD.CommandText = ("INSERT INTO AddCash(Cash_dt,Cash_Time,Ref,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,Amt,Typ,Com) VALUES ('" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & SS & "','" & TxtDes.Text & "','-" & Trim(TxtQ1.Text) & "','-" & Trim(TxtQ2.Text) & "','-" & Trim(TxtQ3.Text) & "','" & Trim(TxtQ4.Text) & "','-" & Trim(TxtQ5.Text) & "','-" & Trim(TxtQ6.Text) & "','-" & Trim(TxtQ7.Text) & "','-" & Trim(TxtQ8.Text) & "','-" & Trim(TxtQ9.Text) & "','-" & Trim(TxtQ10.Text) & "','-" & Trim(TxtQ11.Text) & "','-" & Trim(TxtAmt1.Text) & "','2','TRA')")
        'Cmd.CommandText = ("INSERT INTO InhInv (Inv_no,Inv_com,Inv_dt,Inv_pono,Inv_Flag1,Inv_Code) VALUES ('" & TxtInvNo.Text & "','" & Mid(Lstcom.SelectedValue, 1, 3) & , & DateValue(Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4)) & "','" & TxtPoNo.Text & "','Select','" & "','" & Mid(Trim(LstCode.SelectedValue), 1, 5) & "' )")
        CMD.ExecuteNonQuery()
        '------
        ...
        For Each DemoGridItem In Datagrid3.Items
            ...
            If myCheckbox.Checked = True Then
                ...
                'LblMsg.Text = "The checkbox for {0} was selected<br>"
                If rowCount = 1 Then
                    des1 = Trim(DemoGridItem.Cells(6).Text)
                    ' Des2 += Trim(DemoGridItem.Cells(1).Text)
                    ' TxtHScd.Text += Trim(DemoGridItem.Cells(3).Text)
                Else
                    des1 = Trim(DemoGridItem.Cells(6).Text)
                ...
                CMD.Connection = CON1
                CMD.CommandText = ("UPDATE OutWord SET Typ='2' where Out_Vno='" & des1 & "'")
                CMD.ExecuteNonQuery()
    ...
    Private Sub TxtPedAmt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtPedAmt.TextChanged

    End Sub

    Private Sub Q10_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Q10.TextChanged
