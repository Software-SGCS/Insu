	...
	<BODY topMargin="45" MS_POSITIONING="GridLayout">
		<FORM id="Form1" runat="server">
			...
			<asp:button id="BttApp" style="Z-INDEX: 117; LEFT: 120px; POSITION: absolute; TOP: 384px" runat="server"
				Height="32px" Width="160px" Text="Approval All"></asp:button><asp:panel id="Panel7" style="Z-INDEX: 109; LEFT: 8px; POSITION: absolute; TOP: 160px" runat="server"
				BackColor="Desktop" Height="256px" Width="112px" BackImageUrl="Menu/audit.gif"></asp:panel><asp:panel id="Panel6" style="Z-INDEX: 108; LEFT: 8px; POSITION: absolute; TOP: 32px" runat="server"
				BackColor="Desktop" Height="128px" Width="112px" BackImageUrl="Menu/AssetI.gif"></asp:panel><asp:panel id="Panel5" style="Z-INDEX: 107; LEFT: 120px; POSITION: absolute; TOP: 72px" runat="server"
...
Insurence&nbsp;Payment Note&nbsp;Approval</asp:panel><asp:label id="Label6" style="Z-INDEX: 103; LEFT: 288px; POSITION: absolute; TOP: 40px" runat="server"
				Height="24px" Width="80px" Visible="False">Pass Word</asp:label><asp:textbox id="TxtUser1" style="Z-INDEX: 101; LEFT: 248px; POSITION: absolute; TOP: 40px" runat="server"
				Height="26px" Width="96px" Visible="False"></asp:textbox><asp:label id="Label5" style="Z-INDEX: 102; LEFT: 128px; POSITION: absolute; TOP: 40px" runat="server"
				Height="8px" Width="112px" Visible="False">User Code</asp:label><asp:textbox id="TxtNam" style="Z-INDEX: 104; LEFT: 312px; POSITION: absolute; TOP: 40px" runat="server"
				Height="24px" Width="418px" Visible="False"></asp:textbox><asp:label id="Label7" style="Z-INDEX: 105; LEFT: 128px; POSITION: absolute; TOP: 40px" runat="server"
				Height="24px" Width="96px">Name</asp:label><asp:panel id="Panel8" style="Z-INDEX: 110; LEFT: 8px; POSITION: absolute; TOP: 416px" runat="server"
				BackColor="Desktop" Height="45px" Width="862px"></asp:panel><asp:textbox id="Txtss" style="Z-INDEX: 111; LEFT: 632px; POSITION: absolute; TOP: 40px" runat="server"
				Height="26px" Width="56px" Visible="False"></asp:textbox><asp:textbox id="TxtMail" style="Z-INDEX: 112; LEFT: 720px; POSITION: absolute; TOP: 40px" runat="server"
			...
			<asp:textbox id="TxtPwd1" style="Z-INDEX: 113; LEFT: 408px; POSITION: absolute; TOP: 40px" runat="server"
				Height="26px" Width="96px" Visible="False" TextMode="Password"></asp:textbox><asp:button id="Button3" style="Z-INDEX: 114; LEFT: 304px; POSITION: absolute; TOP: 40px" runat="server"
				...
				Height="16px" Width="88px">Label</asp:label></FORM>
	</BODY>
</HTML>
