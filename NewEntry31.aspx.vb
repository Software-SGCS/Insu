...
#End Region
    ...
    Private Sub Data4()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select EmpMaster.EmpAct as Raw_ItmCode,EmpMaster.Emp_No as Raw_Rec,EmpMaster.Emp_No as Raw_des ,EmpMaster.Emp_Nam as Itm_pri,EmpMaster.OldEpfNo as Raw_opStk,EmpMaster.EmpAct as  Raw_PhStock,EmpMaster.EmpDel as Raw_Soh from EmpMaster where EmpMaster.Emp_Com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "' and EmpDel='N' and EmpAct='Y' ORDER BY EmpMaster.Emp_No", CON)
    ...
    Private Sub ButSub_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButSub.Click
        ...
        For Each gridrow In DataGrid1.Items
            ...
            If Trim(t1) <> Trim(t6) Or Trim(t5) = "Y" Then
                ...
                CMD.CommandText = ("UPDATE EmpMaster SET EmpAct='" & t6 & "',EmpDel='" & Trim(t5) & "',Act_Code='" & Trim(L1.Text) & "',Act_time='" & FormatDateTime(TimeOfDay) & "',Act_Date='" & Format(DateValue(Today()), "MM/dd/yyyy") & "',Act_Act='" & Trim(t6) & "' where Emp_No='" & Trim(t2) & "' and Emp_Com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "'")
                CMD.ExecuteNonQuery()
