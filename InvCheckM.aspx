<%@ Page Language="vb" AutoEventWireup="false" Codebehind="InvCheckM.aspx.vb" Inherits="Insu.InvCheckM" %>
		...
		<DIV style="Z-INDEX: 151; LEFT: 8px; WIDTH: 10px; POSITION: absolute; TOP: 8px; HEIGHT: 10px"
			...
			<FORM id="Form1" runat="server">
				...
				<asp:panel id="Panel6" style="Z-INDEX: 109; LEFT: -8px; POSITION: absolute; TOP: 24px" runat="server"
					BackColor="Desktop" Height="368px" Width="128px" BackImageUrl="Menu/Audit.gif"></asp:panel><asp:panel id="Panel5" runat="server" BackColor="Desktop" Height="24px" Width="767px"></asp:panel><asp:panel id="Panel4" style="Z-INDEX: 107; LEFT: -8px; POSITION: absolute; TOP: -8px" runat="server"
					BackColor="Desktop" Height="32px" Width="820px">
<asp:panel id="Panel2" style="Z-INDEX: 111; LEFT: 0px; POSITION: absolute; TOP: 400px" runat="server"
						Width="876px" Height="32px" BackColor="Desktop"></asp:panel>Administrator 
Page&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invoice 
&nbsp;Approval</asp:panel>
