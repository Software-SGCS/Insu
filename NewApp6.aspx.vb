...
Public Class NewApp6
    ...
    Dim Todt As String
    Dim DSS As CrystalReport5 = New CrystalReport5
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ADA1 = New SqlDataAdapter("SELECT * FROM VehMast WHERE Veh_No='" & Global.PVehno & "'", CON)
        DS = New DataSet
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If strfg = "Not Approved" Then
            ...
            emailMessage.Body = "Vehcle No :" + Global.PVehno + " " + strCom + " " + " From :" + strEfdt + " to :" + strExdt + " Approval is Ok"
