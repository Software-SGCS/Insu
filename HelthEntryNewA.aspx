<%@ Page Language="vb" AutoEventWireup="false" Codebehind="HelthEntryNewA.aspx.vb" Inherits="Insu.HelthEntryNewA" %>
	...
	<body bgColor="#f0f8ff" leftMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:textbox id="TxtInTot" style="Z-INDEX: 117; LEFT: 752px; POSITION: absolute; TOP: 456px"
				runat="server" Width="108px" ReadOnly="True"></asp:textbox><asp:label id="Label5" style="Z-INDEX: 113; LEFT: 376px; POSITION: absolute; TOP: 176px" runat="server"
				...
				Width="76px" Height="472px" BackImageUrl="Menu/bann1.jpg" BackColor="Desktop"></asp:panel><asp:panel id="Panel1" style="Z-INDEX: 101; LEFT: -8px; POSITION: absolute; TOP: 0px" runat="server"
				...
				runat="server" Width="16px" Font-Bold="True" Text="Edit" Visible="False"></asp:button><asp:button id="BtnSave" style="Z-INDEX: 118; LEFT: 112px; POSITION: absolute; TOP: 488px" tabIndex="11"
				runat="server" Width="64px" Font-Bold="True" Text="Save" Visible="False"></asp:button><asp:dropdownlist id="Lstcom" style="Z-INDEX: 105; LEFT: 256px; POSITION: absolute; TOP: 80px" tabIndex="1"
				...
				runat="server" Width="16px" Height="24px" Font-Bold="True" Text="Clear" Visible="False"></asp:button><asp:button id="BtnAdd" style="Z-INDEX: 100; LEFT: 104px; POSITION: absolute; TOP: 456px" tabIndex="7"
				runat="server" Width="56px" Font-Bold="True" Text="Add" Visible="False"></asp:button><asp:textbox id="TxtEmpNo" style="Z-INDEX: 108; LEFT: 256px; POSITION: absolute; TOP: 112px"
				...
				runat="server" Width="64px" Font-Bold="True" Text="Delete" Visible="False"></asp:button><asp:button id="BttIns" style="Z-INDEX: 114; LEFT: 688px; POSITION: absolute; TOP: 208px" runat="server"
			...
			<asp:textbox id="TxtOutTot" style="Z-INDEX: 121; LEFT: 520px; POSITION: absolute; TOP: 456px"
				runat="server" Width="108px" ReadOnly="True"></asp:textbox><asp:image id="Image1" style="Z-INDEX: 122; LEFT: 0px; POSITION: absolute; TOP: 512px" runat="server"
				Width="968px" Height="85px" ImageUrl="Menu/EmpMaster1.jpg"></asp:image><asp:textbox id="TxtChqNo" style="Z-INDEX: 123; LEFT: 720px; POSITION: absolute; TOP: 136px"
				runat="server" Width="72px" Height="26px" Visible="False"></asp:textbox><asp:textbox id="TxtCNo" style="Z-INDEX: 124; LEFT: 752px; POSITION: absolute; TOP: 152px" runat="server"
				...
				runat="server" Width="75px" Visible="False">Label</asp:label>
			<asp:button id="Button1" style="Z-INDEX: 145; LEFT: 256px; POSITION: absolute; TOP: 208px" runat="server"
				Width="80px" Text="Verify 1"></asp:button>
			<asp:button id="Button2" style="Z-INDEX: 146; LEFT: 352px; POSITION: absolute; TOP: 208px" runat="server"
				Width="82px" Text="Verify 2"></asp:button>
			<asp:button id="Button3" style="Z-INDEX: 147; LEFT: 456px; POSITION: absolute; TOP: 208px" runat="server"
				Width="88px" Text="Verify 3 Final"></asp:button></form>
	</body>
</HTML>
