<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Menu1.aspx.vb" Inherits="Insu.Menu1" %>
							...
							<TD width="153" id="cnnNavBar"><!-- navbar-->
								<UL id="IntlNav">
									...
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 145px; HEIGHT: 16px"><A style="WIDTH: 144px; HEIGHT: 5.89%" href="javascript:loadConsumer('EmpMast.aspx','800')">Insurance 
												Vehicle</A></DIV>
									</LI>
									<LI>
										<DIV style="WIDTH: 115px; HEIGHT: 17px"><A style="WIDTH: 144px; HEIGHT: 0.19%" href="javascript:loadConsumer('Entry2.aspx','800')">Insurance 
												Pay</A></DIV>
									</LI>
									<LI>
										<DIV><A style="WIDTH: 144px; HEIGHT: 3.09%" href="javascript:loadConsumer('InsuApproval.aspx','800')">Certificate 
												App</A></DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('PayApproval.aspx','800')">Pay Notice App</A></DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('CrsCertificate.aspx','800')">Rep Certificate</A></DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('Crs.aspx','800')">Rep Pay Notice</A></DIV>
									</LI>
									<LI class="current">
										<DIV><A href="javascript:loadConsumer('ViewReport3.aspx','800')">Certificate View 1</A></DIV>
									</LI>
									<LI class="current">
										<DIV><A href="javascript:loadConsumer('ViewReport4.aspx','800')">Certificate View 2</A></DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('InvCheck.aspx','800')">Invoice Check</A></DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('InvApproval.aspx','800')">Invoice Approval</A></DIV>
									</LI>
									<LI>
										<DIV><A href="javascript:loadConsumer('AccidentForm1.aspx','800')">Accident Request</A></DIV>
									</LI>
									<LI class="current">
