	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:imagebutton id="ImageButton1" style="Z-INDEX: 104; LEFT: 824px; POSITION: absolute; TOP: 80px"
				runat="server" Height="24px" Width="80px" ImageUrl="Menu\print.jpg" Visible="False"></asp:imagebutton><asp:button id="Button14" style="Z-INDEX: 130; LEFT: 272px; POSITION: absolute; TOP: 400px"
				runat="server" Height="24px" Width="144px" Text="Summery Report1 -XLS"></asp:button><asp:button id="Button11" style="Z-INDEX: 129; LEFT: 504px; POSITION: absolute; TOP: 168px"
				runat="server" Height="24px" Width="96px" Text="Report 1-Pdf"></asp:button><asp:button id="Button13" style="Z-INDEX: 128; LEFT: 432px; POSITION: absolute; TOP: 360px"
				runat="server" Height="24px" Width="144px" Text="Premium Report2 -PDF"></asp:button><asp:button id="Button12" style="Z-INDEX: 127; LEFT: 272px; POSITION: absolute; TOP: 360px"
				runat="server" Height="24px" Width="144px" Text="Premium Report2 -XLS"></asp:button><asp:button id="Button10" style="Z-INDEX: 126; LEFT: 272px; POSITION: absolute; TOP: 328px"
				runat="server" Height="24px" Width="144px" Text="Premium Report1 -XLS"></asp:button><asp:button id="Button9" style="Z-INDEX: 124; LEFT: 432px; POSITION: absolute; TOP: 328px" runat="server"
				Height="24px" Width="144px" Text="Premium Report1 -PDF"></asp:button><asp:label id="Label4" style="Z-INDEX: 123; LEFT: 136px; POSITION: absolute; TOP: 328px" runat="server"
				Height="24px" Width="56px">Year</asp:label><asp:textbox id="Txtyr" style="Z-INDEX: 122; LEFT: 208px; POSITION: absolute; TOP: 328px" runat="server"
				Width="48px"></asp:textbox><asp:button id="Button8" style="Z-INDEX: 121; LEFT: 368px; POSITION: absolute; TOP: 288px" runat="server"
				Height="24px" Width="96px" Text="Summery-Email"></asp:button><asp:button id="Button7" style="Z-INDEX: 119; LEFT: 240px; POSITION: absolute; TOP: 288px" runat="server"
				Height="24px" Width="96px" Text="Summery-Pdf"></asp:button><asp:button id="Button6" style="Z-INDEX: 118; LEFT: 128px; POSITION: absolute; TOP: 288px" runat="server"
				Height="24px" Width="104px" Text="Summery-Excell"></asp:button><asp:button id="Button5" style="Z-INDEX: 117; LEFT: 240px; POSITION: absolute; TOP: 240px" runat="server"
				Width="96px" Text="Report 3-Pdf"></asp:button><asp:button id="Button4" style="Z-INDEX: 116; LEFT: 128px; POSITION: absolute; TOP: 240px" runat="server"
				Height="24px" Width="104px" Text="Report 3-Excell"></asp:button><asp:button id="Button2" style="Z-INDEX: 114; LEFT: 128px; POSITION: absolute; TOP: 200px" runat="server"
				...
				Width="80px"></asp:textbox><asp:button id="Button3" style="Z-INDEX: 115; LEFT: 240px; POSITION: absolute; TOP: 200px" runat="server"
				Width="96px" Text="Report 2-Pdf"></asp:button><asp:label id="L1" style="Z-INDEX: 120; LEFT: 128px; POSITION: absolute; TOP: 560px" runat="server"
