...
#End Region
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select Veh_No,Veh_Com, Veh_Typ,Convert(varchar(10),Veh_EfDt,103) as Veh_EfDt, Convert(varchar(10),Veh_Exdt,103) as Veh_Exdt, Veh_tpay ,Veh_val,Veh_TotChqPay,Allow1,Veh_bpay,Veh_rcc,Veh_tr from VehMast where ALLOW2='Approved' and ALLOW1='Select' and SOLD='N' and veh_com='" & Trim(Mid(LstCat.SelectedValue, 1, 3)) & "'", objConn)
    ...
    Public Sub BindTheGrid1()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select Veh_No,Veh_Com, Veh_Typ,Convert(varchar(10),Veh_EfDt,103) as Veh_EfDt, Convert(varchar(10),Veh_Exdt,103) as Veh_Exdt, Veh_tpay ,Veh_val,Veh_TotChqPay,Allow1,Veh_bpay,Veh_rcc,Veh_tr from VehMast where ALLOW2='Approved' and ALLOW1='Select' and Veh_CertifyNo<>' '", objConn)
    ...
    Public Sub dtgCustomers_Update(ByVal sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        If strfg = "Approved" Then
            ...
            emailMessage.To = "health@samsoncorporates.com"
            ...
            emailMessage.Body = "Vehcle No :" + strid + " " + strCom + " " + " From :" + strEfdt + " to :" + strExdt + " Approval is Ok" + "      " + "http://192.168.12.181/Insu/CrsCertificate.aspx"
    ...
    Private Sub BttApp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttApp.Click
        ...
        If Count1 <> 0 Then
            For Each dtr2 In DS.Tables("VehMast").Rows
                ...
                Dim emailMessage As MailMessage
                emailMessage = New MailMessage
                emailMessage.From = "chamindas@samsoncorporates.com"
