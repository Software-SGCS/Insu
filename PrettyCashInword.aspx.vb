...
Public Class PrettyCashInword
    ...
    Dim count1, count, count2, count3 As Integer
    Dim depno As String
    Dim depname As String
    Dim S1(10) As String
    Dim epfno As String
    Dim tot1 = 0
    Dim tot4, tot2, tot3 As Double
    Dim Des1 As String
    Dim Des2 As String
    ...
    Protected WithEvents TxtPAmt1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtPAmt As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtPayAmt As System.Web.UI.WebControls.TextBox
    Protected WithEvents Label33 As System.Web.UI.WebControls.Label
    Protected WithEvents TxtPayAmt1 As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents TxtP3 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP4 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP5 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP6 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP7 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP8 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP9 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP10 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP11 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtExcAmt As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtP1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtExcAmt1 As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents TxtExcAmt11 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR2 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR3 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR4 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR5 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR6 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR7 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR8 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR9 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR10 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtR11 As System.Web.UI.WebControls.TextBox
    Protected WithEvents TxtRAmt As System.Web.UI.WebControls.TextBox
    Protected WithEvents Label36 As System.Web.UI.WebControls.Label
    Protected WithEvents TxtRAmt1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents Labmsg As System.Web.UI.WebControls.Label
    Protected WithEvents CheckBox1 As System.Web.UI.WebControls.CheckBox
    Protected WithEvents CheckBox2 As System.Web.UI.WebControls.CheckBox
    Protected WithEvents pnd As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DR.Close()
        CMD = New SqlCommand("SELECT In_Vno From InWord where id =(select max(id) from InWord)", CON1)
    ...
    Public Sub BindTheGrid1()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select a.id as id,a.In_Vno as Out_Vno ,b.Emp_no as Emp_no , b.Emp_Nam as Emp_Nam , b.Emp_Dep as Emp_Dep, b.Emp_Com as Emp_Com,REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,a.In_CashAmt),1), '','') as In_CashAmt,REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,a.In_PayAmt),1), '','') as In_PayAmt,REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,a.In_PedAmt),1), '','') as In_PedAmt,REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,a.In_ChgAmt),1), '','') as In_ChgAmt from InWord a,Employee b where (a.In_Eno=b.Emp_no) and a.In_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "' order by a.id", CON1)
        cmdCustomers.CommandType = CommandType.Text
    ...
    Public Sub BindTheGrid3()
        ...
        While DR.Read
            ...
            TxtQVal.Text = (Val(Q1.Text) * 5000) + (Val(Q2.Text) * 2000) + (Val(Q3.Text) * 1000) + (Val(Q4.Text) * 500) + (Val(TxtQ5.Text) * 100) + (Val(Q6.Text) * 50) + (Val(Q7.Text) * 20) + (Val(Q8.Text) * 10) + (Val(Q9.Text) * 5) + (Val(Q10.Text) * 2) + (Val(Q11.Text) * 1)
    ...
    '  SS = "Select a.id as id,a.Out_Vno as Out_Vno ,b.Emp_no as Emp_no , b.Emp_Nam as Emp_Nam , b.Emp_Dep as Emp_Dep, b.Emp_Com as Emp_Com,a.Out_Amt as Out_Amt from OutWord a,Employee b where a.Out_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "' and a.Out_Eno=b.Emp_no"
        ...
        ' Dim cmdCustomers As SqlCommand = New SqlCommand("Select a.id as id,a.Out_Vno as Out_Vno ,b.Emp_no as Emp_no , b.Emp_Nam as Emp_Nam , b.Emp_Dep as Emp_Dep, b.Emp_Com as Emp_Com,a.Out_Amt as Out_Amt from OutWord a,Employee b where (a.Out_Eno=b.Emp_no) and a.Out_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'", CON1)
    '  Dim cmdCustomers As SqlCommand = New SqlCommand("Select  id,Out_Vno ,Out_Eno as Emp_no, REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,Out_Amt),1), '','') as Out_Amt, Convert(Varchar(10),Out_Date,103) as Out_Date from OutWord where Out_Eno='" & Trim(txtEmpNo.Text) & "'", CON1)
    '  cmdCustomers.CommandType = CommandType.Text
    ...
    Private Sub Data4()
        ...
        SS = Trim(Mid(Lstcom.SelectedValue, 1, 3))


        ' If ss = "DSI" Then
        ' SS1 = "Select MasterDocs.Mas_IndNos as Raw_ItmCode,MasterDocs.Mas_Des as Raw_des,Mas_HsCode as Mas_BnkCode,Mas_InTrm,Mas_Amt,Mas_Cncy,Mas_BnkCode As Mas_Bnk  from MasterDocs where Mas_SupCode='" & Trim(Mid(LstCat.SelectedValue, 1, 5)) & "' and Mas_PyTrm='" & Trim(Mid(LstPTm.SelectedValue, 1, 2)) & "' and (Mas_CmpnyCode='DI2' or Mas_CmpnyCode='DI1' or Mas_CmpnyCode='DSI' OR Mas_CmpnyCode='SL/') ORDER BY MasterDocs.Mas_IndNos"

        'Else
        '  ss1 = "Select MasterDocs.Mas_IndNos as Raw_ItmCode,MasterDocs.Mas_Des as Raw_des,Mas_HsCode as Mas_BnkCode,Mas_InTrm,Mas_Amt,Mas_Cncy,Mas_BnkCode As Mas_Bnk   from MasterDocs where Mas_SupCode='" & Trim(Mid(LstCat.SelectedValue, 1, 5)) & "' and Mas_PyTrm='" & Trim(Mid(LstPTm.SelectedValue, 1, 2)) & "' and Mas_CmpnyCode='" & Trim(Mid(LstCom.SelectedValue, 1, 3)) & "' ORDER BY MasterDocs.Mas_IndNos"

        'End If

        SS1 = "Select  id,Out_Vno AS Raw_ItmCode,Out_Eno as Raw_des, REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,Out_Amt),1), '','') as Mas_BnkCode, Convert(Varchar(10),Out_Date,103) as Mas_InTrm,Out_Amt as Mas_Amt from OutWord where Out_Eno='" & Trim(txtEmpNo.Text) & "' and Out_Flg='Y'"
        ' Dim cmdCustomers As SqlCommand = New SqlCommand("Select  id,Out_Vno ,Out_Eno as Emp_no, REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,Out_Amt),1), '','') as Out_Amt, Convert(Varchar(10),Out_Date,103) as Out_Date from OutWord where Out_Eno='" & Trim(txtEmpNo.Text) & "'", CON1)


        Dim cmdCustomers As SqlCommand = New SqlCommand(SS1, CON1)
        cmdCustomers.CommandType = CommandType.Text
    ...
    Private Sub BtnSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        ...
        For Each DemoGridItem In Datagrid3.Items
            Dim myCheckbox As CheckBox = CType(DemoGridItem.Cells(4).Controls(1), CheckBox)
        ...
        LblMsg.Text = Val(tot1)
        TxtPAmt1.Text = Val(tot1)
        TxtPAmt.Text = "        " + Format(tot1, "###,###,###.00")


        'TxtValue.Text = Right("********" + Format(tot1, "###,###,###.##"), 15)

        'TxtTotval.Text = Right("             " + Format(tot1, "###############.##"), 20)

        'txtCncy.Text = Trim(DemoGridItem.Cells(6).Text)
        'txtInc.Text = Trim(DemoGridItem.Cells(4).Text)
        ' Txtcncy1.Text = Trim(DemoGridItem.Cells(6).Text)
        'TxtBnk.Text = Trim(DemoGridItem.Cells(7).Text)
        ...
        'TxtIndentNo.Text = Des1
        'TxtDes.Text = Des2
        'TxtIndentNo.Visible = True
        TxtDes.Visible = True

        TxtPayAmt1.Text = "        " + Format(Val(TxtPayAmt.Text), "###,###,###.00")
        TxtAmt.Text = "       0.00"
        TxtAmt.Text = Space(10) + Format(Val(TxtAmt.Text), "###,###,###.00")
        ...
        If Val(TxtPayAmt.Text) > Val(TxtPAmt1.Text) Then

            L3.ForeColor = System.Drawing.Color.White
            L3.BackColor = System.Drawing.Color.Green
            L3.Text = "                    " + Format((Val(TxtPayAmt.Text) - (Val(TxtPAmt1.Text) - Val(TxtAmt1.Text))), "###,###,###.00")
            TxtExcAmt11.Text = Val(TxtPayAmt.Text) - Val(TxtPAmt1.Text) - Val(TxtAmt1.Text)
            L2.Text = Val(TxtPayAmt.Text) - (Val(TxtPAmt1.Text))
        ...
        Else
            L3.ForeColor = System.Drawing.Color.White
            L3.BackColor = System.Drawing.Color.Red
            L3.Text = "                    " + Format((Val(TxtPAmt1.Text) + Val(TxtAmt1.Text)) - (Val(TxtPayAmt.Text)), "###,###,###.00")

            TxtExcAmt11.Text = Val(TxtPayAmt.Text) + Val(TxtPAmt1.Text) - Val(TxtAmt1.Text)
            L2.Text = (Val(TxtPAmt1.Text)) - (Val(TxtPayAmt.Text))
        ...
        End If
        'ss1 = Mid(Trim(txtRefno.Text), 14, 5)
    ...
    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        ...
        SS = "SELECT Out_Vno From OutWord where ID =(select max(ID) from InWord"
        Cmd1 = New SqlCommand("SELECT In_Vno From InWord where ID =(select max(ID) from InWord)", CON1)
        ...
        If ct <> 0 Then
            ...
            For Each drt2 In DS.Tables("VoucherNo").Rows
                ...
                Dim q, r, s As String
                Dim p As Double
                If Mid(Trim(LstCom1.SelectedValue), 1, 3) = "DSI" Then

                    s = Mid(drt2("Dsi_Vno"), 4, 6)
                    r = drt2("Dsi_cd")
                    p = Val(s) + 1
                    r = Trim(r) + "-000000"
                ...
                Else
                    ...
                    Cmd1 = New SqlCommand("SELECT Vou_no From Imprest where Imp_Com ='" & Mid(Trim(LstCom1.SelectedValue), 1, 3) & "'", CON1)
                    ...
                    r = Trim(Mid(Trim(LstCom1.SelectedValue), 1, 3)) + "-00000"
                    q = Format(p, r)
        ...
        If Mid(Trim(LstCom1.SelectedValue), 1, 3) = "DSI" Then
            ...
            Dim Cmd11 As New SqlCommand("UPDATE VoucherNo SET Dsi_Vno='" & Trim(TxtInvNo.Text) & "'", CON1)
        ...
        Else
            ...
            Dim Cmd11 As New SqlCommand("UPDATE Imprest SET Vou_no='" & Trim(TxtInvNo.Text) & "' where Imp_Com ='" & Mid(Trim(LstCom1.SelectedValue), 1, 3) & "'", CON1)
            Cmd11.ExecuteNonQuery()
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        For Each DemoGridItem In Datagrid3.Items
            ...
            If myCheckbox.Checked = True Then
                ...
                If CheckBox2.Checked = True Then
                    ...
                    TxtExcAmt1.Text = ""
                    TxtPAmt.Text = TxtPayAmt1.Text
                    TxtPAmt1.Text = TxtPayAmt.Text

                    CMD.Connection = CON1
                    CMD.CommandText = ("UPDATE OutWord SET Out_Amt=Out_Amt-" & Val(TxtPayAmt.Text) & ",Out_Flg='Y',Typ='1',Set_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "' where Out_Vno='" & Des1 & "'")
                    CMD.ExecuteNonQuery()

                Else

                    CMD.Connection = CON1
                    CMD.CommandText = ("UPDATE OutWord SET Out_Flg='N',Typ='1',Set_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "' where Out_Vno='" & Des1 & "'")
                    CMD.ExecuteNonQuery()
        ...
        ADA = New SqlDataAdapter("SELECT * FROM InWord where In_Vno='" & Trim(TxtInvNo.Text) & "'", CON1)
        DS = New DataSet
        ADA.Fill(DS, "InWord")
        Dim ct As Integer
        ct = DS.Tables("InWord").Rows.Count
        ...
        TxtP10.ReadOnly = True
        TxtP11.ReadOnly = True
        ...
        Else
            ...
            SS = "INSERT INTO InWord (In_Vno,In_Date,In_Des,In_Eno,In_CashAmt,In_Q1,In_Q2,In_Q3,In_Q4,In_Q5,In_Q6,In_Q7,In_Q8,In_Q9,In_Q10,In_Q11,In_Flg,In_PayAmt,In_PedAmt,In_ChgAmt) VALUES ('" & TxtInvNo.Text & "','" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & TxtDes.Text & "','" & Trim(TxtEpfNo.Text) & "','" & Trim(TxtExcAmt1.Text) & "','" & Trim(TxtP1.Text) & "','" & Trim(TxtP2.Text) & "','" & Trim(TxtP3.Text) & "','" & Trim(TxtP4.Text) & "','" & Trim(TxtP5.Text) & "','" & Trim(TxtP6.Text) & "','" & Trim(TxtP7.Text) & "','" & Trim(TxtP8.Text) & "','" & Trim(TxtP9.Text) & "','" & Trim(TxtP10.Text) & "','" & Trim(TxtP11.Text) & "','Y'," & Val(TxtPayAmt.Text) & "," & Val(TxtPAmt1.Text) & "," & Val(TxtAmt1.Text) & ")"

            CMD.CommandText = ("INSERT INTO InWord (In_Vno,In_Date,In_Com,In_Des,In_Eno,In_CashAmt,In_Q1,In_Q2,In_Q3,In_Q4,In_Q5,In_Q6,In_Q7,In_Q8,In_Q9,In_Q10,In_Q11,In_Flg,In_PayAmt,In_PedAmt,In_ChgAmt,Typ) VALUES ('" & TxtInvNo.Text & "','" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & Mid(Trim(LstCom1.SelectedValue), 1, 3) & "','" & TxtDes.Text & "','" & Trim(TxtEpfNo.Text) & "','" & Trim(TxtExcAmt1.Text) & "','" & Trim(TxtP1.Text) & "','" & Trim(TxtP2.Text) & "','" & Trim(TxtP3.Text) & "','" & Trim(TxtP4.Text) & "','" & Trim(TxtP5.Text) & "','" & Trim(TxtP6.Text) & "','" & Trim(TxtP7.Text) & "','" & Trim(TxtP8.Text) & "','" & Trim(TxtP9.Text) & "','" & Trim(TxtP10.Text) & "','" & Trim(TxtP11.Text) & "','Y'," & Val(TxtPayAmt.Text) & "," & Val(TxtPAmt1.Text) & "," & Val(TxtAmt1.Text) & ",'1')")
            'Cmd.CommandText = ("INSERT INTO InhInv (Inv_no,Inv_com,Inv_dt,Inv_pono,Inv_Flag1,Inv_Code) VALUES ('" & TxtInvNo.Text & "','" & Mid(Lstcom.SelectedValue, 1, 3) & , & DateValue(Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4)) & "','" & TxtPoNo.Text & "','Select','" & "','" & Mid(Trim(LstCode.SelectedValue), 1, 5) & "','1' )")
            CMD.ExecuteNonQuery()

        End If
        SS = "SELECT * FROM Employee where Emp_No='" & Trim(txtEmpNo.Text) & "'"
        ADA = New SqlDataAdapter("SELECT * FROM Employee where Emp_No='" & Trim(txtEmpNo.Text) & "'", CON1)
        DS = New DataSet
        ADA.Fill(DS, "Employee")
        'Dim ct As Integer
        ct = DS.Tables("Employee").Rows.Count
        If ct <> 0 Then
        ...
        Else
            ...
            CMD.Connection = CON1
            CMD.CommandText = ("INSERT INTO Employee (Emp_No,Emp_Nam,Emp_Dep,Emp_Com) VALUES ('" & Trim(txtEmpNo.Text) & "','" & TxtEmpNam.Text & "','" & Trim(TxtDepNam.Text) & "','" & Trim(TxtCom.Text) & "')")
        ...
        '  Dim Cmd11 As New SqlCommand("UPDATE VoucherNo SET Out_Vno='" & sinvno & "'", CON1)
        ' Cmd11.ExecuteNonQuery()
        ...
        If ct <> 0 Then
            ...
            For Each drt2 In DS.Tables("CashInBox").Rows


                If Val(TxtPayAmt.Text) > (Val(TxtPAmt1.Text)) Then


                    q1 = Val(drt2("Q1")) - Val(TxtP1.Text)
                    q2 = Val(drt2("Q2")) - Val(TxtP2.Text)
                    q3 = Val(drt2("Q3")) - Val(TxtP3.Text)
                    q4 = Val(drt2("Q4")) - Val(TxtP4.Text)
                    q5 = Val(drt2("Q5")) - Val(TxtP5.Text)
                    q6 = Val(drt2("Q6")) - Val(TxtP6.Text)
                    q7 = Val(drt2("Q7")) - Val(TxtP7.Text)
                    q8 = Val(drt2("Q8")) - Val(TxtP8.Text)
                    q9 = Val(drt2("Q9")) - Val(TxtP9.Text)
                    q10 = Val(drt2("Q10")) - Val(TxtP10.Text)
                    q11 = Val(drt2("Q11")) - Val(TxtP11.Text)
            ...
            CMD.Connection = CON1
            'CMD.CommandText = ("INSERT INTO CashInBox (O1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11) VALUES (" & q1 & "," & q2 & "," & q3 & "," & q4 & "," & q5 & "," & q6) & "," & q7 & "," & q8 & "," & q9 & "," & q10 & "," & q11 & ")")
            'Cmd.CommandText = ("INSERT INTO InhInv (Inv_no,Inv_com,Inv_dt,Inv_pono,Inv_Flag1,Inv_Code) VALUES ('" & TxtInvNo.Text & "','" & Mid(Lstcom.SelectedValue, 1, 3) & , & DateValue(Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4)) & "','" & TxtPoNo.Text & "','Select','" & "','" & Mid(Trim(LstCode.SelectedValue), 1, 5) & "' )")

            ' CMD.CommandText = ("UPDATE CashInBox SET Q1='" & q1 & "',Q2='" & q2 & "',Q3='" & q3 & "',Q4='" & q4 & "',Q5='" & q5 & "',Q6='" & q6 & "',Q7='" & q7 & "',Q8='" & q8 & "',Q9='" & q9 & "',Q10='" & q10 & "',Q11='" & q11 & "' where Qtyp='1')")
            CMD.CommandText = ("UPDATE CashInBox SET Q1=" & q1 & ",Q2=" & q2 & ",Q3=" & q3 & ",Q4=" & q4 & ",Q5=" & q5 & ",Q6=" & q6 & ",Q7=" & q7 & ",Q8=" & q8 & ",Q9=" & q9 & ",Q10=" & q10 & ",Q11=" & q11 & ",C_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "' where Qtyp='1'")
            ...
            If count2 = 0 Then
                ...
                SS = "INSERT INTO CashBoxEnd(Vou_Date,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,typ)VALUES('" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & q1 & "'," & q2 & "," & q3 & "," & q4 & "," & q5 & "," & q6 & "," & q7 & "," & q8 & "," & q9 & "," & q10 & "," & q11 & ",'1')"
                CMD.CommandText = ("INSERT INTO CashBoxEnd(Vou_Date,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,Typ)VALUES('" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'," & q1 & "," & q2 & "," & q3 & "," & q4 & "," & q5 & "," & q6 & "," & q7 & "," & q8 & "," & q9 & "," & q10 & "," & q11 & ",'1')")
                CMD.ExecuteNonQuery()
            Else
                CMD.CommandText = ("UPDATE CashBoxEnd SET Q1=" & q1 & ",Q2=" & q2 & ",Q3=" & q3 & ",Q4=" & q4 & ",Q5=" & q5 & ",Q6=" & q6 & ",Q7=" & q7 & ",Q8=" & q8 & ",Q9=" & q9 & ",Q10=" & q10 & ",Q11=" & q11 & ",typ='1' where Typ='1' and Vou_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'")
        ...
        If ct <> 0 Then
            ...
            For Each drt2 In DS.Tables("CashInBox").Rows
                ...
                q1 = Val(drt2("Q1")) + Val(TxtQ1.Text)
                q2 = Val(drt2("Q2")) + Val(TxtQ2.Text)
                q3 = Val(drt2("Q3")) + Val(TxtQ3.Text)
                q4 = Val(drt2("Q4")) + Val(TxtQ4.Text)
                q5 = Val(drt2("Q5")) + Val(TxtQ5.Text)
                q6 = Val(drt2("Q6")) + Val(TxtQ6.Text)
                q7 = Val(drt2("Q7")) + Val(TxtQ7.Text)
                q8 = Val(drt2("Q8")) + Val(TxtQ8.Text)
                q9 = Val(drt2("Q9")) + Val(TxtQ9.Text)
                q10 = Val(drt2("Q10")) + Val(TxtQ10.Text)
                q11 = Val(drt2("Q11")) + Val(TxtQ10.Text)
        ...
        If ct <> 0 Then
            ...
            For Each drt2 In DS.Tables("CashInBox").Rows
                ...
                q1 = Val(drt2("Q1")) - Val(TxtR1.Text)
                q2 = Val(drt2("Q2")) - Val(TxtR2.Text)
                q3 = Val(drt2("Q3")) - Val(TxtR3.Text)
                q4 = Val(drt2("Q4")) - Val(TxtR4.Text)
                q5 = Val(drt2("Q5")) - Val(TxtR5.Text)
                q6 = Val(drt2("Q6")) - Val(TxtR6.Text)
                q7 = Val(drt2("Q7")) - Val(TxtR7.Text)
                q8 = Val(drt2("Q8")) - Val(TxtR8.Text)
                q9 = Val(drt2("Q9")) - Val(TxtR9.Text)
                q10 = Val(drt2("Q10")) - Val(TxtR10.Text)
                q11 = Val(drt2("Q11")) - Val(TxtR10.Text)
        ...
        If Val(TxtAmt1.Text) > 0 Then
            ...
            ' CMD.CommandText = ("UPDATE CashInBox SET Q1='" & q1 & "',Q2='" & q2 & "',Q3='" & q3 & "',Q4='" & q4 & "',Q5='" & q5 & "',Q6='" & q6 & "',Q7='" & q7 & "',Q8='" & q8 & "',Q9='" & q9 & "',Q10='" & q10 & "',Q11='" & q11 & "' where Qtyp='1')")
            CMD.CommandText = ("INSERT INTO Change(Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,In_Vno,In_Typ) values ( " & Val(TxtQ1.Text) & "," & Val(TxtQ2.Text) & "," & Val(TxtQ3.Text) & "," & Val(TxtQ4.Text) & "," & Val(TxtQ5.Text) & "," & Val(TxtQ6.Text) & "," & Val(TxtQ7.Text) & "," & Val(TxtQ8.Text) & "," & Val(TxtQ9.Text) & "," & Val(TxtQ10.Text) & "," & Val(TxtQ11.Text) & ",'" & Trim(TxtInvNo.Text) & "','1')")
        ...
        If Val(TxtRAmt1.Text) > 0 Then
            ...
            ' CMD.CommandText = ("UPDATE CashInBox SET Q1='" & q1 & "',Q2='" & q2 & "',Q3='" & q3 & "',Q4='" & q4 & "',Q5='" & q5 & "',Q6='" & q6 & "',Q7='" & q7 & "',Q8='" & q8 & "',Q9='" & q9 & "',Q10='" & q10 & "',Q11='" & q11 & "' where Qtyp='1')")
            CMD.CommandText = ("INSERT INTO Change(Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,In_Vno,In_Typ) values ( " & Val(TxtR1.Text) & "," & Val(TxtR2.Text) & "," & Val(TxtR3.Text) & "," & Val(TxtR4.Text) & "," & Val(TxtR5.Text) & "," & Val(TxtR6.Text) & "," & Val(TxtR7.Text) & "," & Val(TxtR8.Text) & "," & Val(TxtR9.Text) & "," & Val(TxtR10.Text) & "," & Val(TxtR11.Text) & ",'" & Trim(TxtInvNo.Text) & "','2')")
        ...
        CMD.Connection = CON1
        CMD.CommandText = ("UPDATE Imprest SET Imp_pay= Imp_pay+" & Val(TxtPayAmt.Text) & " where Imp_Com='" & Mid(Trim(LstCom1.SelectedValue), 1, 3) & "'")
        CMD.ExecuteNonQuery()


        'CMD1.Connection = CON1
        CMD.CommandText = ("UPDATE SignCashEnd SET Pay_Amt= Pay_Amt+" & Val(TxtPayAmt.Text) & " where Com='" & Mid(Trim(LstCom1.SelectedValue), 1, 3) & "' and typ='1' and Vou_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'")
        CMD.ExecuteNonQuery()
        ...
        If Mid(Trim(LstCom1.SelectedValue), 1, 3) = "DSI" Then
            ...
            Dim Cmd11 As New SqlCommand("UPDATE VoucherNo SET Dsi_Vno='" & Trim(TxtInvNo.Text) & "',Dsi_Cd='" & Mid(Trim(TxtInvNo.Text), 1, 2) & "'", CON1)
            Cmd11.ExecuteNonQuery()
    ...
    Private Sub Lstcom_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lstcom.SelectedIndexChanged
        ...
        TxtPayAmt.Text = "      0.00"
        TxtPayAmt1.Text = "        " + Format(Val(TxtPayAmt1.Text), "###,###,###.00")
        TxtPAmt.Text = "      0.00"
        TxtPAmt.Text = "        " + Format(Val(TxtPAmt.Text), "###,###,###.00")

        TxtExcAmt.Text = "      0.00"
        TxtExcAmt.Text = "        " + Format(Val(TxtExcAmt.Text), "###,###,###.00")
        TxtExcAmt1.Text = "      0.00"

        TxtAmt.Text = "      0.00"
        TxtAmt.Text = "        " + Format(Val(TxtAmt.Text), "###,###,###.00")
        TxtAmt1.Text = "      0.00"
        ...
        TxtP7.ReadOnly = False
        TxtP8.ReadOnly = False
        TxtP9.ReadOnly = False


        TxtP10.ReadOnly = False
        TxtP11.ReadOnly = False
        ...
        SS = "SELECT Emp_Dep FROM EmpAdmin WHERE Emp_No = '" & Mid(Lstcom.SelectedValue, 1, 3) & "' and Emp_com='SGC'"
        Cmd = New SqlCommand("SELECT Emp_DepNo,Emp_Nam,Emp_No FROM EmpAdmin WHERE Emp_No = '" & Trim(TxtEpfNo.Text) & "'", CON)
    ...
    Private Sub cal()
        ...
        TxtAmt.Text = Space(10) + Format(Val(TxtAmt1.Text), "###,###,###.00")

        TxtRAmt1.Text = (Val(TxtR1.Text) * 5000) + (Val(TxtR2.Text) * 2000) + (Val(TxtR3.Text) * 1000) + (Val(TxtR4.Text) * 500) + (Val(TxtR5.Text) * 100) + (Val(TxtR6.Text) * 50) + (Val(TxtR7.Text) * 20) + (Val(TxtR8.Text) * 10) + (Val(TxtR9.Text) * 5) + (Val(TxtR10.Text) * 2) + (Val(TxtR11.Text) * 1)
        TxtRAmt.Text = Space(10) + Format(Val(TxtRAmt1.Text), "###,###,###.00")
        tot2 = Val(TxtAmt1.Text) - Val(TxtRAmt1.Text)

        If Val(TxtPayAmt.Text) > Val(TxtPAmt1.Text) Then

            L3.ForeColor = System.Drawing.Color.White
            L3.BackColor = System.Drawing.Color.Green
            L3.Text = Space(10) + Format((Val(TxtPayAmt.Text) - Val(TxtPAmt1.Text) + tot2), "###,###,###.00")
            L2.Text = Val(TxtPayAmt.Text) - Val(TxtPAmt1.Text) + tot2
        Else
            L3.ForeColor = System.Drawing.Color.White
            L3.BackColor = System.Drawing.Color.Red
            L3.Text = Space(10) + Format((Val(TxtPAmt1.Text) - Val(TxtPayAmt.Text) + tot2), "###,###,###.00")
            L2.Text = Val(TxtPAmt1.Text) - Val(TxtPayAmt.Text) + tot2

        End If


        TxtExcAmt1.Text = (Val(TxtP1.Text) * 5000) + (Val(TxtP2.Text) * 2000) + (Val(TxtP3.Text) * 1000) + (Val(TxtP4.Text) * 500) + (Val(TxtP5.Text) * 100) + (Val(TxtP6.Text) * 50) + (Val(TxtP7.Text) * 20) + (Val(TxtP8.Text) * 10) + (Val(TxtP9.Text) * 5) + (Val(TxtP10.Text) * 2) + (Val(TxtP11.Text) * 1)
        TxtExcAmt.Text = Space(10) + Format(Val(TxtExcAmt1.Text), "###,###,###.00")

        If Val(TxtExcAmt1.Text) = Val(L2.Text) Then
    ...
    Private Sub TxtPayAmt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtPayAmt.TextChanged
        TxtPayAmt1.Text = Space(10) + Format(Val(TxtPayAmt1.Text), "###,###,###.00")
    End Sub
    ...
    Private Sub TxtP2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP2.TextChanged
        cal()
    End Sub

    Private Sub TxtP3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP3.TextChanged
        cal()

    End Sub

    Private Sub TxtP4_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP4.TextChanged
        cal()

    End Sub

    Private Sub TxtP5_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP5.TextChanged
        cal()
    End Sub

    Private Sub TxtP6_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP6.TextChanged
        cal()

    End Sub

    Private Sub TxtP7_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP7.TextChanged
        cal()
    End Sub

    Private Sub TxtP8_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP8.TextChanged
        cal()
    End Sub

    Private Sub TxtP9_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP9.TextChanged
        cal()
    End Sub

    Private Sub TxtP10_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP10.TextChanged
        cal()
    End Sub

    Private Sub TxtP11_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtP11.TextChanged
        cal()
    End Sub

    Private Sub TxtExcAmt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtExcAmt.TextChanged
    ...
    Private Sub TxtR3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR3.TextChanged
        cal()
    End Sub

    Private Sub TxtR4_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR4.TextChanged
        cal()
    End Sub

    Private Sub TxtR5_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR5.TextChanged
        cal()
    End Sub

    Private Sub TxtR6_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR6.TextChanged
        cal()
    End Sub

    Private Sub TxtR7_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR7.TextChanged
        cal()
    End Sub

    Private Sub TxtR8_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR8.TextChanged
        cal()
    End Sub

    Private Sub TxtR9_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR9.TextChanged
        cal()
    End Sub

    Private Sub TxtR10_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR10.TextChanged
        cal()
    End Sub

    Private Sub TxtR11_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtR11.TextChanged
        cal()
    End Sub
