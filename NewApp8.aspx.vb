...
#End Region
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        strfg = "Not Approved"
        strSql = "UPDATE InhInv SET Inv_Flag2='" & strfg & "',Inv_Flag1= 'Select' WHERE Inv_Flag2='Select' and Inv_No='" & strInvNo & "'"
        cmdCustomers = New SqlCommand(strSql, CON)
        ' objConn.Open()
        cmdCustomers.ExecuteReader(CommandBehavior.CloseConnection)
        CON = New SqlConnection
        ...
        BODY += "<img src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question4.jpg' width='103' height='127' /><img src='file://///sgcsser/C/Inetpub/wwwroot/Insu/Menu/question8.jpg' width='94' height='129' />"
        ...
        BODY += " <tr>"
        BODY += "<td width='100'><form method='post' action=http://sgcsser/Insu/NewApp5.aspx?TYPE=" & strInvNo & " name='frm1'><input name='sbb1' type='image' src='/Menu/question13.jpg' width='100' height='30'> </form></td>"
        BODY += "</form></td>"
        BODY += "<td width='1'>&nbsp;</td>"
        BODY += "<td width='68'>&nbsp;</td>"
        BODY += "</tr>"
        ...
        emailMessage.Subject = "Inv No :" + strInvNo + " " + StrInvcom + " " + " Inv Date :" + Strdt + " Your Approval is Not OK" + " "
