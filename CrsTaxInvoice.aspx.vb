...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            CMD = New SqlCommand("SELECT Form_name,Form_level FROM FormTable where Form_name='CrsTaxInvoice.aspx' and Form_level='" & Global.PwLevel & "'", CON)
        ...
        If Not IsPostBack Then
            ...
            CMD = New SqlCommand("SELECT Inv_no,Inv_com FROM InhInv where inv_flag2='Approved' order by Inv_no", CON)
