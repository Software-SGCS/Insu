...
#End Region
    ...
    Private Sub BtnApp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnApp.Click
        ...
        If BtnAdd.Enabled = False Then
            CMD.CommandText = ("UPDATE AccPayNew SET Company='" & com & "',Chq_no='" & Trim(TxtChqNo.Text) & "',Final_Amt='" & Trim(TxtFinalAmt.Text) & "',Final_fg='" & cfg1 & "',Final_Img='" & flfg1 & "',Remakes='" & Trim(txtRem.Text) & "',Fin_svg='" & Trim(svgfg1) & "' WHERE Veh_no='" & Trim(LstId.SelectedValue) & "' and Claim_No='" & Trim(TxtVehClNo.Text) & "'")
            CMD.ExecuteNonQuery()
        Else
