	...
	<body bgColor="#ffffff" leftMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:textbox id="TxtRelAge" style="Z-INDEX: 118; LEFT: 664px; POSITION: absolute; TOP: 224px"
				...
				Width="968px" Height="64px" Font-Bold="True" HorizontalAlign="Left" Enabled="False" ForeColor="White" BorderColor="Transparent" BackImageUrl="Menu/banner.jpg"
				BackColor="Desktop"><FONT style="BACKGROUND-COLOR: #000066">
					<asp:panel id="Panel3" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 64px" runat="server"
						Width="112px" Height="560px" BackColor="Desktop" BackImageUrl="Menu/EmpMaster4.jpg"></asp:panel>
					<asp:Label id="Label13" style="Z-INDEX: 102; LEFT: 464px; POSITION: absolute; TOP: 176px" runat="server"
						Width="72px" Font-Size="XX-Small" Height="16px" BackColor="White" BorderColor="Transparent"
						ForeColor="Black">DD/MM/YYYY</asp:Label>Death Donation Data Entry</FONT></asp:panel>
			<asp:panel id="Panel2" style="Z-INDEX: 103; LEFT: 0px; POSITION: absolute; TOP: 589px" runat="server"
				...
				runat="server" Font-Size="X-Small" Width="426px"></asp:textbox><asp:textbox id="TxtRelId" style="Z-INDEX: 116; LEFT: 432px; POSITION: absolute; TOP: 224px"
				tabIndex="7" runat="server" Font-Size="X-Small" Width="144px"></asp:textbox><asp:textbox id="Txtfg" style="Z-INDEX: 117; LEFT: 256px; POSITION: absolute; TOP: 256px" tabIndex="9"
			...
			<DIV id="Layer1" style="Z-INDEX: 100; LEFT: 120px; OVERFLOW: scroll; WIDTH: 736px; POSITION: absolute; TOP: 288px; HEIGHT: 236px"><asp:datagrid id="MyDataGrid" runat="server" Font-Size="Small" Width="712px" Height="10px" ForeColor="Black"
					...
					<HeaderStyle Font-Size="10pt" Font-Names="Tahoma" Font-Bold="True" ForeColor="White" BackColor="#6B696B"></HeaderStyle>
			...
			<asp:panel id="Panel5" style="Z-INDEX: 139; LEFT: 880px; POSITION: absolute; TOP: 64px" runat="server"
				Width="88px" Height="528px" BackImageUrl="Menu/EmpMaster4.jpg" BackColor="Desktop"></asp:panel><asp:label id="Label15" style="Z-INDEX: 140; LEFT: 416px; POSITION: absolute; TOP: 256px" runat="server"
