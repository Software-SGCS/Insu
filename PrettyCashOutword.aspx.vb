...
Public Class PrettyCashOutword
    ...
    Protected WithEvents Ok1 As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Public Sub BindTheGrid1()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select a.id as id,a.Out_Vno as Out_Vno ,b.Emp_no as Emp_no , b.Emp_Nam as Emp_Nam , b.Emp_Dep as Emp_Dep, b.Emp_Com as Emp_Com,REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,a.Out_Amt),1), '','') as Out_Amt from OutWord a,Employee b where (a.Out_Eno=b.Emp_no) and a.Out_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'", CON1)
        cmdCustomers.CommandType = CommandType.Text
    ...
    Public Sub BindTheGrid2()
        ...
        ' Dim cmdCustomers As SqlCommand = New SqlCommand("Select a.id as id,a.Out_Vno as Out_Vno ,b.Emp_no as Emp_no , b.Emp_Nam as Emp_Nam , b.Emp_Dep as Emp_Dep, b.Emp_Com as Emp_Com,a.Out_Amt as Out_Amt from OutWord a,Employee b where (a.Out_Eno=b.Emp_no) and a.Out_Date='" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "'", CON1)
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select  id,Out_Vno ,Out_Eno as Emp_no, REPLACE(CONVERT(VARCHAR,CONVERT(MONEY,Out_Amt),1), '','') as Out_Amt, Convert(Varchar(10),Out_Date,103) as Out_Date from OutWord where Out_Eno='" & Trim(txtEmpNo.Text) & "' and Out_Flg='Y'", CON1)
        cmdCustomers.CommandType = CommandType.Text
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Else
            ...
            CMD.Connection = CON1
            CMD.CommandText = ("INSERT INTO OutWord (Out_Vno,Out_Date,Out_Des,Out_Eno,Out_Amt,Out_Q1,Out_Q2,Out_Q3,Out_Q4,Out_Q5,Out_Q6,Out_Q7,Out_Q8,Out_Q9,Out_Q10,Out_Q11,Out_Flg,Typ) VALUES ('" & TxtInvNo.Text & "','" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & TxtDes.Text & "','" & Trim(TxtEpfNo.Text) & "','" & Trim(TxtAmt1.Text) & "','" & Trim(TxtQ1.Text) & "','" & Trim(TxtQ2.Text) & "','" & Trim(TxtQ3.Text) & "','" & Trim(TxtQ4.Text) & "','" & Trim(TxtQ5.Text) & "','" & Trim(TxtQ6.Text) & "','" & Trim(TxtQ7.Text) & "','" & Trim(TxtQ8.Text) & "','" & Trim(TxtQ9.Text) & "','" & Trim(TxtQ10.Text) & "','" & Trim(TxtQ11.Text) & "','Y','1')")
        ...
        Else
            ...
            CMD.Connection = CON1
            CMD.CommandText = ("INSERT INTO OutWord (Out_Vno,Out_Date,Out_Des,Out_Eno,Out_Amt,Out_Q1,Out_Q2,Out_Q3,Out_Q4,Out_Q5,Out_Q6,Out_Q7,Out_Q8,Out_Q9,Out_Q10,Out_Q11,Out_Flg) VALUES ('" & TxtInvNo.Text & "','" & Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4) & "','" & TxtDes.Text & "','" & Trim(TxtEpfNo.Text) & "','" & Trim(TxtAmt1.Text) & "','" & Trim(TxtQ1.Text) & "','" & Trim(TxtQ2.Text) & "','" & Trim(TxtQ3.Text) & "','" & Trim(TxtQ4.Text) & "','" & Trim(TxtQ5.Text) & "','" & Trim(TxtQ6.Text) & "','" & Trim(TxtQ7.Text) & "','" & Trim(TxtQ8.Text) & "','" & Trim(TxtQ9.Text) & "','" & Trim(TxtQ10.Text) & "','" & Trim(TxtQ11.Text) & "','Y')")
            'Cmd.CommandText = ("INSERT INTO InhInv (Inv_no,Inv_com,Inv_dt,Inv_pono,Inv_Flag1,Inv_Code) VALUES ('" & TxtInvNo.Text & "','" & Mid(Lstcom.SelectedValue, 1, 3) & , & DateValue(Mid(Trim(TxtInvDt.Text), 4, 2) + "/" + Mid(Trim(TxtInvDt.Text), 1, 2) + "/" + Mid(Trim(TxtInvDt.Text), 7, 4)) & "','" & TxtPoNo.Text & "','Select','" & "','" & Mid(Trim(LstCode.SelectedValue), 1, 5) & "' )")
            CMD.ExecuteNonQuery()
        ...
        If ct <> 0 Then
            ...
            For Each drt2 In DS.Tables("CashInBox").Rows
                ...
                q11 = Val(drt2("Q11")) - Val(TxtQ11.Text)
