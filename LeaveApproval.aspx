<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LeaveApproval.aspx.vb" Inherits="Insu.LeaveApproval" %>
<HTML>
	<HEAD>
			...
			<asp:datagrid id="dtgCustomers" style="Z-INDEX: 101; LEFT: 56px; POSITION: absolute; TOP: 168px; Design_Time_Lock: True"
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="Approve ">
						<ItemTemplate>
							<asp:Label id=lblfg Text='<%# DataBinder.Eval(Container.DataItem, "Trn_fg") %>' Runat="server">
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							Total Leave :
							...
							<asp:Label id=lblTaLv Text='<%# DataBinder.Eval(Container.DataItem, "Emp_Talv") %>' Runat="server" Visible="True">
							</asp:Label>Balance :
							<asp:Label id=lblbaLv Text='<%# DataBinder.Eval(Container.DataItem, "Emp_balv") %>' Runat="server" Visible="True">
							</asp:Label>
