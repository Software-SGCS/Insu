...
#End Region
    ...
    Private Sub ImgBtn3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImgBtn3.Click
        ...
        'ADA = New SqlDataAdapter("SELECT * FROM VehMast WHERE ((((VehMast.Veh_Efdt)>='" & fdate1 & "' And (VehMast.Veh_Exdt)<='" & fdate2 & "') and ((VehMast.allow1)='" & ss1 & "')) and (((VehMast.Veh_Com) = '" & VehCom11 & "') and ((VehMast.Sold) = 'N')))" & " order by Id", CON)
        ADA = New SqlDataAdapter("SELECT * FROM VehMast WHERE ((VehMast.Veh_Efdt>='" & fdate1 & "' And VehMast.Veh_Exdt<='" & fdate2 & "')  and (VehMast.Veh_Com = '" & VehCom11 & "' and VehMast.Sold= 'N'))" & " order by Id", CON)
    ...
    Private Sub Butt1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Butt1.Click
        ...
        Dim DSS As VehRep21 = New VehRep21
