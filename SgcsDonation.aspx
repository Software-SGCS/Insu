<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SgcsDonation.aspx.vb" Inherits="Insu.SgcsDonation" %>
							...
							<TD id="cnnNavBar" width="153"><!-- navbar-->
								<UL id="IntlNav">
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV style="WIDTH: 150px; HEIGHT: 16px"><A href="javascript:loadConsumer('Dispaly1.aspx','800')">Death 
												Donation</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV style="WIDTH: 145px; HEIGHT: 16px"><A style="WIDTH: 144px; HEIGHT: 5.89%" href="javascript:loadConsumer('EntryEmployeeMaster.aspx','800')">Master 
												Data</A></DIV>
									<LI>
										<DIV style="WIDTH: 115px; HEIGHT: 17px"><A style="WIDTH: 144px; HEIGHT: 0.19%" href="javascript:loadConsumer('DeathDonation2.aspx','800')">Death 
												Donation Payment </A>
										</DIV>
									<LI>
										<DIV><A style="WIDTH: 144px; HEIGHT: 3.09%" href="javascript:loadConsumer('DDFEntry.aspx','800')">Death 
												Donation-Recieved </A>
										</DIV>
									<LI>
										<DIV><A href="javascript:loadConsumer('Dispaly1','800')">Report1</A></DIV>
									</LI>
									<LI class="current" style="WIDTH: 159px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('Dispaly1.aspx','800')">Health Donation</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('HthEmployeeMaster.aspx','800')">Employee Master 
												Data</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('HelthEntry.aspx','800')">Health Claims </A>
										</DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('HthEntry.aspx','800')">Health Fund Recieved </A>
										</DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('HealthReport1.aspx','800')">Reports 1</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
										<DIV><A href="javascript:loadConsumer('HealthReport2.aspx','800')">Reports 2</A></DIV>
									</LI>
									<LI style="WIDTH: 154px; HEIGHT: 0%">
