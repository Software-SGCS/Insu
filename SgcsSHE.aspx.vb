...
Public Class SgcsSHE
    ...
    Dim sCOM, sEPFNO, SCNam, STEmail, SChqNo, FNAME, FNAME1, FNAME2 As String
    ...
    Private Sub Btt1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btt1.Click
        ...
        If TxtPwd.Text = Global.Ppwd Then
            ...
            Else
                ...
                ADADB = New OleDbDataAdapter("Select * from data where mid(trim(f2),1,2)='20' AND mid(trim(f11),1,3)='YES' ORDER BY F2", Conn)
                ...
                Dim Dsst As SibNewrpt = New SibNewrpt
                Dim DiskOptst1 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                ...
                Dsst.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                Dsst.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                DiskOptst1.DiskFileName = Server.MapPath("Data/" & "SibInsurance.pdf")
                Dsst.ExportOptions.DestinationOptions = DiskOptst1
                Dsst.Export()
                If COUNT <> 0 Then
                    ...
                    'emailMessage1.From = "insurance@dsisamson.com"
                    emailMessage1.To = "nelanim@samsoncorporates.com,chamindas@samsoncorporates.com,udanip@samsoncorporates.com,insurance@samsoncorporates.com,health4@samsoncorporates.com,palithan@samsoncorporates.com"
                    'emailMessage1.To = "palithan@samsoncorporates.com"
                    emailMessage1.Subject = "SIB Insurance Daily Updates" + " "
                    ...
                    For Each dr1 In DS.Tables("data").Rows
                        ...
                        Try
                            ...
                            If IsDBNull(Trim(dr1("F5"))) Then
                                f5 = Space(60)
                            Else
                                f5 = Mid(Trim(dr1("F5")) + Space(75), 1, 60)
                            End If
                        Catch ex As Exception
                            'labelStatus.Text="Unable to send the e-mail message"
                            ' labelStatus.Text = ex.ToString
                        ...
                        vehexdt = Trim(dr1("F2"))
                        Tfdt = Mid(Todt, 1, 2) + "/" + Mid(Todt, 4, 2) + "/" + Trim(Mid(Todt, 7, 4))
                        ' Ttdt = Format(Trim(dr2("Veh_ExDt")), "MM/dd/yyyy")

                        If Val(Mid(Trim(dr1("F2")), 1, 4)) = Val(Trim(Mid(Todt, 7, 4))) Then
                            f9 = "No"
                        Else
                        ...
                        Ttdt = Mid(Trim(dr1("F2")), 6, 2) + "/" + Mid(Trim(dr1("F2")), 9, 2) + "/" + Trim(Str(COUNT2))
                        Try
                        ...
                        Ttdt = Mid(Trim(dr1("F2")), 9, 2) + "/" + Mid(Trim(dr1("F2")), 6, 2) + "/" + Trim(Mid(Trim(dr1("F2")), 1, 4))

                        Todt = Format(Today, "MM/dd/yyyy")
                        f2 = Mid(Trim(dr1("F2")), 9, 2) + "/" + Mid(Trim(dr1("F2")), 6, 2) + "/" + Trim(Mid(Todt, 7, 4))
                    ...
                    Next
                    emailMessage1.Body = "Please refer the attachment" & vbCrLf

                    FNAME = Server.MapPath("Data/" & "SibInsurance.pdf")
                    emailMessage1.Attachments.Add(New MailAttachment(FNAME))


                    Dim Dsst1 As SibNewrpt1 = New SibNewrpt1
                    Dim DiskOptst2 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                    ' Dss.SetDatabaseLogon("sa", "tstc123")
                    'Dss.SetParameterValue("Com", "" & com11 & "")
                    'Dss.SetParameterValue("fm", "" & TEmail & "")
                    'Dss.SetParameterValue("tm", "" & FEmail & "")
                    Dsst1.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                    Dsst1.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                    DiskOptst2.DiskFileName = Server.MapPath("Data/" & "SibInqueries.pdf")
                    Dsst1.ExportOptions.DestinationOptions = DiskOptst2
                    Dsst1.Export()
                    FNAME = Server.MapPath("Data/" & "SibInqueries.pdf")
                    emailMessage1.Attachments.Add(New MailAttachment(FNAME))


                    Dim Dsst2 As SibNewrpt2 = New SibNewrpt2
                    Dim DiskOptst3 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                    ' Dss.SetDatabaseLogon("sa", "tstc123")
                    'Dss.SetParameterValue("Com", "" & com11 & "")
                    'Dss.SetParameterValue("fm", "" & TEmail & "")
                    'Dss.SetParameterValue("tm", "" & FEmail & "")
                    Dsst2.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                    Dsst2.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                    DiskOptst3.DiskFileName = Server.MapPath("Data/" & "DsiInqueries.pdf")
                    Dsst2.ExportOptions.DestinationOptions = DiskOptst3
                    Dsst2.Export()
                    FNAME = Server.MapPath("Data/" & "DsiInqueries.pdf")
                    emailMessage1.Attachments.Add(New MailAttachment(FNAME))
                    ...
                    DiskOptst4.DiskFileName = Server.MapPath("Data/" & "VehicleDSIGroup.pdf")
                    Dsst3.ExportOptions.DestinationOptions = DiskOptst4
                    Dsst3.Export()
                    FNAME = Server.MapPath("Data/" & "VehicleDSIGroup.pdf")
                    emailMessage1.Attachments.Add(New MailAttachment(FNAME))
                ...
                '----------
                '-------------------*****
                ADADB = New OleDbDataAdapter("Select * from Payment", Conn)
                '
                ' 'ADADB = New OleDbDataAdapter("Select * from data", Conn)
                DS = New DataSet
                ADADB.Fill(DS, "data")
                ...
                ' Sflg2 = "No"
                Todt = Format(Today, "MM/dd/yyyy")
                Dim emailMessage7 As MailMessage


                emailMessage7 = New MailMessage
                Dim Dss1 As SIB1 = New SIB1
                Dim DiskOpts1 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                ' Dss.SetDatabaseLogon("sa", "tstc123")
                'Dss.SetParameterValue("Com", "" & com11 & "")
                'Dss.SetParameterValue("fm", "" & TEmail & "")
                'Dss.SetParameterValue("tm", "" & FEmail & "")
                Dss1.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                Dss1.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                DiskOpts1.DiskFileName = Server.MapPath("Data/" & "SeeAttached2.pdf")
                Dss1.ExportOptions.DestinationOptions = DiskOpts1
                Dss1.Export()
                If COUNT <> 0 Then

                    emailMessage7.From = "insurance@dsisamson.com"
                    emailMessage7.To = "chamindas@samsoncorporates.com,udanip@samsoncorporates.com,insurance@samsoncorporates.com,palithan@samsoncorporates.com"
                    'emailMessage7.To = "palithan@samsoncorporates.com"

                    emailMessage7.Subject = "SIB Age Analyst" + " "

                    emailMessage7.Body += "REFNO            DATE        INSURER                          TYPE OF POLICY          POLICY NO         SUM INSURED      SERVICE NAME    No of Days" & vbCrLf
                    emailMessage7.Body += "---------------------------------------------------------------------------------------------------------------------------------------------------" & vbCrLf
                    COUNT1 = 0



                    emailMessage7.Body = "Please refer the attachment" & vbCrLf

                    FNAME = Server.MapPath("Data/" & "SeeAttached2.pdf")
                    emailMessage7.Attachments.Add(New MailAttachment(FNAME))

                    If Sflg2 = "Yes" Then
                        SmtpMail.SmtpServer = "mail.dsisamson.com"
                        Try
                            If COUNT <> 0 Then
                                SmtpMail.Send(emailMessage7)
                ...
                Sflg2 = "No"
                Todt = Format(Today, "MM/dd/yyyy")
                Dim emailMessage8 As MailMessage


                emailMessage8 = New MailMessage
                Dim Dss3 As SgcsLoan = New SgcsLoan
                Dim DiskOpts3 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                ' Dss.SetDatabaseLogon("sa", "tstc123")
                'Dss.SetParameterValue("Com", "" & com11 & "")
                'Dss.SetParameterValue("fm", "" & TEmail & "")
                'Dss.SetParameterValue("tm", "" & FEmail & "")

                Dss3.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                Dss3.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                Try
                    DiskOpts3.DiskFileName = Server.MapPath("Data/" & "SeeAttached3.pdf")

                    'labelStatus.Text="Unable to send the e-mail message"
                    ' labelStatus.Text = ex.ToString
                    FNAME = Server.MapPath("Data/" & "SeeAttached3.pdf")


                    Dss3.ExportOptions.DestinationOptions = DiskOpts3
                    Dss3.Export()
                Catch ex As Exception
                ...
                End Try
                emailMessage8.From = "insurance@dsisamson.com"
                emailMessage8.To = "chamindas@samsoncorporates.com,udanip@samsoncorporates.com,insurance@samsoncorporates.com,palithan@samsoncorporates.com"
                'emailMessage8.To = "palithan@samsoncorporates.com"

                emailMessage8.Subject = "Sgcs Loan" + " "


                emailMessage8.Body += "Please refer the attachment" & vbCrLf
                Try
                    FNAME = Server.MapPath("Data/" & "SeeAttached3.pdf")
                    emailMessage8.Attachments.Add(New MailAttachment(FNAME))
                    ' emailMessage8.Attachments.Add(New System.Web.Mail.MailAttachment(nextFile))
                Catch ex As Exception
                    'labelStatus.Text="Unable to send the e-mail message"
                    ' labelStatus.Text = ex.ToString
                ...
                If (CDate(Todt)).DayOfWeek = 1 Then
                    ...
                    If COUNT <> 0 Then
                        ...
                        '--------------
                        Todt = Format(Today, "MM/dd/yyyy")
                        Dim emailMessage9 As MailMessage


                        emailMessage9 = New MailMessage
                        Dim Dss4 As DsiShip = New DsiShip
                        Dim DiskOpts4 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                        ' Dss.SetDatabaseLogon("sa", "tstc123")
                        'Dss.SetParameterValue("Com", "" & com11 & "")
                        'Dss.SetParameterValue("fm", "" & TEmail & "")
                        'Dss.SetParameterValue("tm", "" & FEmail & "")

                        Dss4.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                        Dss4.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                        Try
                            DiskOpts4.DiskFileName = Server.MapPath("Data/" & "Dsi.pdf")

                            'labelStatus.Text="Unable to send the e-mail message"
                            ' labelStatus.Text = ex.ToString
                            FNAME = Server.MapPath("Data/" & "Dsi.pdf")


                            Dss4.ExportOptions.DestinationOptions = DiskOpts4
                            Dss4.Export()
                        Catch ex As Exception
                        ...
                        End Try
                        Dim Dss5 As ScomShip = New ScomShip
                        Dim DiskOpts5 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                        ' Dss.SetDatabaseLogon("sa", "tstc123")
                        'Dss.SetParameterValue("Com", "" & com11 & "")
                        'Dss.SetParameterValue("fm", "" & TEmail & "")
                        'Dss.SetParameterValue("tm", "" & FEmail & "")

                        Dss5.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                        Dss5.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                        Try
                            DiskOpts5.DiskFileName = Server.MapPath("Data/" & "Scom.pdf")

                            'labelStatus.Text="Unable to send the e-mail message"
                            ' labelStatus.Text = ex.ToString
                            FNAME1 = Server.MapPath("Data/" & "Scom.pdf")


                            Dss5.ExportOptions.DestinationOptions = DiskOpts5
                            Dss5.Export()
                        Catch ex As Exception
                        ...
                        End Try
                        Dim Dss6 As AllShip = New AllShip
                        Dim DiskOpts6 As CrystalDecisions.Shared.DiskFileDestinationOptions = New CrystalDecisions.Shared.DiskFileDestinationOptions
                        ' Dss.SetDatabaseLogon("sa", "tstc123")
                        'Dss.SetParameterValue("Com", "" & com11 & "")
                        'Dss.SetParameterValue("fm", "" & TEmail & "")
                        'Dss.SetParameterValue("tm", "" & FEmail & "")

                        Dss6.ExportOptions.ExportDestinationType = CrystalDecisions.[Shared].ExportDestinationType.DiskFile
                        Dss6.ExportOptions.ExportFormatType = CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat
                        Try
                            DiskOpts6.DiskFileName = Server.MapPath("Data/" & "AllShip.pdf")

                            'labelStatus.Text="Unable to send the e-mail message"
                            ' labelStatus.Text = ex.ToString
                            FNAME2 = Server.MapPath("Data/" & "AllShip.pdf")


                            Dss6.ExportOptions.DestinationOptions = DiskOpts6
                            Dss6.Export()
                        Catch ex As Exception
                        ...
                        emailMessage9.From = "insurance@dsisamson.com"
                        'emailMessage9.To = "chamindas@samsoncorporates.com,udanip@samsoncorporates.com,insurance@samsoncorporates.com,palithan@samsoncorporates.com"
                        emailMessage9.To = "chithralg@samsoncorporates.com,nilushig@samsoncorporates.com,palithan@samsoncorporates.com,imports@samsoncorporates.com,chathurip@samsoncorporates.com"

                        emailMessage9.Subject = "Reminder-Refund Container Deposit List" + " "


                        emailMessage9.Body += "Please refer attachments" & vbCrLf
                        ' FNAME = Server.MapPath("Data/" & "Import1.pdf,Import2.pdf,Import3.pdf")
                        Try
                            'FNAME = Server.MapPath("Data/" & "Import1.pdf")
                            emailMessage9.Attachments.Add(New MailAttachment(FNAME))
                            emailMessage9.Attachments.Add(New MailAttachment(FNAME1))
                            emailMessage9.Attachments.Add(New MailAttachment(FNAME2))
                            ' emailMessage8.Attachments.Add(New System.Web.Mail.MailAttachment(nextFile))
                        ...
                        emailMessage.Body += "COMPANY SHIPPING LINE                INDENT NOS             AMOUNT    FCL DATE     No of Days" & vbCrLf
                        ...
                        For Each dr1 In DS.Tables("data1").Rows
                            ...
                            If dtdiff >= 0 And Trim(ss) = "" Then
                                ...
                                sp1 = "   " + Trim(Str(dtdiff))
                                sp1 = Right(sp1, 4)
                                emailMessage.Body += "" & f2 & " " & f4 & "  " & f7 & "  " & f8 & "  " & Mid(vehexdt, 4, 2) + "/" + Mid(vehexdt, 1, 2) + "/" + Mid(vehexdt, 7, 4) & "    " & sp1 & vbCrLf
                                Sflg2 = ss
                            End If
                ...
                If (CDate(Todt)).DayOfWeek = 1 Then
                    ...
                    If COUNT <> 0 Then
                        ...
                        'emailMessage3.To = "dkay@dsifootwear.com,kasun@dsifootwear.com,chithralg@samsoncorporates.com,imports@samsoncorporates.com,jayaniw@dsifootwear.com,nilushig@samsoncorporates.com,acc4@dsifootwear.com,thanujem@dsifootwear.com"
                        emailMessage3.To = "chithralg@samsoncorporates.com,imports@samsoncorporates.com,nilushig@samsoncorporates.com"
                        'emailMessage3.To = "palithan@samsoncorporates.com"
                        emailMessage3.Subject = "Outstanding Container Deposit schedule" & vbCrLf
                        emailMessage3.Body += "COMPANY SHIPPING LINE                INDENT NOS             AMOUNT    FCL DATE    No of Days" & vbCrLf
                        ...
                        For Each dr1 In DS.Tables("data3").Rows
                            ...
                            Ttdt = Mid(vehexdt, 4, 2) + "/" + Mid(vehexdt, 1, 2) + "/" + Mid(vehexdt, 7, 4)
                            ...
                            If dtdiff >= 0 And Trim(ss) = "" Then
                                ...
                                sp1 = "     " + Trim(Str(dtdiff))
                                sp1 = Right(sp1, 4)
                                emailMessage3.Body += "" & f2 & " " & f4 & " " & f7 & " " & f8 & " " & Mid(vehexdt, 4, 2) + "/" + Mid(vehexdt, 1, 2) + "/" + Mid(vehexdt, 7, 4) & "    " & sp1 & vbCrLf
                                emailMessage3.Body += " " & vbCrLf
                    ...
                    If COUNT <> 0 Then
                        ...
                        emailMessage4.From = "insurance@dsisamson.com"

                        'emailMessage.From = "insurance@dsisamson.com"

                        'emailMessage4.To = "dkay@dsifootwear.com,kasun@dsifootwear.com,chithralg@samsoncorporates.com,imports@samsoncorporates.com,samanm@samsoncompounds.com,nilushig@samsoncorporates.com,accounts7@samsoncompounds.com"
                        'emailMessage4.To = "palithan@samsoncorporates.com"
                        emailMessage4.To = "chithralg@samsoncorporates.com,imports@samsoncorporates.com"
                        emailMessage4.Subject = "Outstanding Container Deposit schedule" & vbCrLf
                        emailMessage4.Body += "COMPANY SHIPPING LINE                INDENT NOS             AMOUNT    FCL DATE    No of Days" & vbCrLf
                        ...
                        For Each dr1 In DS.Tables("data4").Rows
                            ...
                            If dtdiff >= 0 And Trim(ss) = "" Then
                                ...
                                sp1 = "   " + Trim(Str(dtdiff))
                                sp1 = Right(sp1, 4)
                                emailMessage4.Body += "" & f2 & " " & f4 & " " & f7 & "  " & f8 & "  " & Mid(vehexdt, 4, 2) + "/" + Mid(vehexdt, 1, 2) + "/" + Mid(vehexdt, 7, 4) & "    " & sp1 & vbCrLf
                                emailMessage4.Body += " " & vbCrLf
                                Sflg2 = ss
                            End If
                ...
                If COUNT <> 0 Then
                    ...
                    'emailMessage1.From = "insurance@dsisamson.com"
                    emailMessage2.To = "chamindas@samsoncorporates.com,udanip@samsoncorporates.com,health1@samsoncorporates.com,palithan@samsoncorporates.com"
                ...
                If Val(Mid(Todt, 4, 2)) > 5 Then

                    Cmd1.Connection = CON
                    Cmd1.CommandText = "UPDATE Vehflag SET Veh_flag='N'"
                    Cmd1.ExecuteNonQuery()
                ...
                ADA = New SqlDataAdapter("Select *  from Vehflag", CON)
                DS = New DataSet
                ADA.Fill(DS, "Vehflag")

                COUNT = DS.Tables("Vehflag").Rows.Count

                For Each dr1 In DS.Tables("Vehflag").Rows

                    Try
                        If IsDBNull(Trim(dr1("Veh_flag"))) Then
                            flg = "N"
                        Else
                            flg = Trim(dr1("Veh_flag"))
                        End If
                ...
                If (Mid(Todt, 4, 2) = "01" Or Mid(Todt, 4, 2) = "02" Or Mid(Todt, 4, 2) = "03" Or Mid(Todt, 4, 2) = "04" Or Mid(Todt, 4, 2) = "05") And flg = "N" Then
                    ...
                    If COUNT <> 0 Then
                        ...
                        End Try
                        Cmd1.Connection = CON
                        Cmd1.CommandText = "UPDATE Vehflag SET Veh_flag='Y'"
                        Cmd1.ExecuteNonQuery()
                ...
                emailMessage.To = "chamindas@samsoncorporates.com"
